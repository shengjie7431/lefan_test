...
<form id="editForm" role="form" action="${ctx}/info/publishs/save" method="post">
        ...
        <table class="table">
            <tbody>
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" id="userName" name="userName" value="${dto.userName}" style="width: 400px;" class="form-control" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">手机号</th>
                    <td width="80%">
                        <input type="text" id="userTel" name="userTel" value="${dto.userTel}"  style="width: 400px;" class="form-control" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">身份证号</th>
                    <td width="80%">
                        <input type="text" id="userCardid" name="userCardid" value="${dto.userCardid}" style="width: 400px;" class="form-control" required="required">
                    </td>
                </tr>
                <%--<tr>--%>
                    ...
                    <%--<td width="80%">--%>
                        ...
                        <%--&lt;%&ndash;<input type="text" id="safeCompanyNames" name="safeCompanyNames"&ndash;%&gt;--%>
                               <%--&lt;%&ndash;style="width: 400px;display: inline-block; background-color: #d3d3d3;"&ndash;%&gt;--%>
                               <%--&lt;%&ndash;class="form-control" required="required" onfocus="this.blur();">&ndash;%&gt;--%>
                        <%--<input type="button" value="选  择" onclick="selectCompany(null,'add')"  style="width: 78px;  height: 32px;"/>--%>
                    <%--</td>--%>
                <%--</tr>--%>
                <tr>
                    <th width="20%" class="active">其他信息</th>
                    <td width="80%">
                        <textarea  id="userOtherInfo" name="userOtherInfo" style="width: 400px; height: 150px" class="form-control">${dto.userOtherInfo}</textarea>
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">问题描述</th>
                    <td width="80%">
                        <textarea  id="problemRemark" name="problemRemark" required="required" style="width: 400px; height: 150px" class="form-control">${dto.problemRemark}</textarea>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="modal-footer">
        <button type="submit" class="btn btn-success loading-btn" data-loading-text="Loading..." autocomplete="off"><span class="glyphicon glyphicon-ok"></span> 提交</button>
    </div>
</form>
</div>
