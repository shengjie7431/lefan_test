                    ...
                    <c:forEach items="${file}" var="file">
                        <li>
                            <a href='javascript:void(0);'>
                                <c:if test="${file.fileType == 'jpg'}">
                                    <img src='${file.filePath}' width='90px' height='60px'  bigimg='${file.filePath}' />
                                </c:if>
                                <c:if test="${file.fileType == 'txt'}">
                                    <img src='${ctx}/img/txt.png' width='90px' height='60px'  bigimg='${ctx}/img/txt.png' />
                                </c:if>
                                <c:if test="${file.fileType == 'doc'}">
                                    <img src='${ctx}/img/word.png' width='90px' height='60px'  bigimg='${ctx}/img/word.png' />
                                </c:if>
                                <c:if test="${file.fileType == 'xls'}">
                                    <img src='${ctx}/img/excel.png' width='90px' height='60px'  bigimg='${ctx}/img/excel.png' />
                                </c:if>
                                <c:if test="${file.fileType == 'pdf'}">
                                    <img src='${ctx}/img/pdf.jpg' width='90px' height='60px'  bigimg='${ctx}/img/pdf.jpg' />
                                </c:if>
