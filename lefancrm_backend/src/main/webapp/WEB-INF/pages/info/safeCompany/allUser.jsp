...
<div class="main administrator">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/infoSafeCompany/selectAllUser" method="post">
        ...
        <form id="editForm" role="form" action="${ctx}/infoSafeCompany/confirmUser" method="post">
            <table class="table table-hover">
                ...
                <c:forEach items="${apiRsp.results}" var="item">
                    <tr>
                        <td><input type="checkbox" value="${item.userId}" name="users"></td>
                        <td>${item.userName}</td>
                        <td>${item.userTel}</td>
                        <td>${item.nickName}</td>
                        <td>${item.orgName}</td>
    ...
    <div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/infoSafeCompany/selectAllUser?userName=${userName}&userTel=${userTel}&safeCompanyId=${safeCompanyId}" />
