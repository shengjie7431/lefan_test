        ...
        <form id="editForm" role="form" action="${ctx}/case/report/saveCaseMediationLegal"  method="post">
            ...
            <div class="items">
                <div class="item active" id="item1">
                    ...
                    <div class="item-title">诉讼方案调解报告</div>
    ...
    function myCallBack(event,param){
        ...
        if(apiRsp){
            if(apiRsp.results.noNext == 1 || apiRsp.results.noNext == 3){
                ...
                var url = "${ctx}/case/report/caseMediationLegal?caseId="+'${caseId}'+"&caseNo="+'${caseNo}'+"&op="+'${op}'+"&type=55"+"&stepCode="+apiRsp.results.stepCode+"&noNext="+apiRsp.results.noNext;
