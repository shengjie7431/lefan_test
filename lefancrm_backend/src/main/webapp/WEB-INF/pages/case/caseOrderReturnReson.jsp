...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/case/caseOrderReturnReject" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <textarea type="text" id = "reson" name="reson" style="width: 400px; height: 150px"  class="form-control"></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
