...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/caseApply/add" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" id = "carNumber" name="carNumber"   style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">救治医院</th>
                    <td width="80%">
                        <input type="text" id = "cureHospital" name="cureHospital"   style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">伤者信息</th>
                    <td id="injuryType" width="80%">
                        我撞了人<input type="radio"  name="injuryType" value="0" style="width: 50px;">
                        我被撞了<input type="radio"   name="injuryType" value="1" style="width: 50px;">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">他方是</th>
                    <td id="otherType" width="80%">
                        机动车<input type="radio"  name="otherType" value="0" style="width: 50px;">
                        非机动车<input type="radio"   name="otherType" value="1" style="width: 50px;">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">我方是</th>
                    <td width="80%">
                        机动车<input type="radio"  name="weType" value="0" style="width: 50px;">
                        非机动车<input type="radio"   name="weType" value="1" style="width: 50px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td  width="80%">
                        <input name="dangerTime"  style="width: 400px;" type="text"  class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly>
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">医疗费垫付</th>
                    <td  width="80%">
                        否<input type="radio"  name="isNeedAdvance" value="0" style="width: 50px;">
                        是<input type="radio"   name="isNeedAdvance" value="1" style="width: 50px;">
                    </td>
                </tr>
                </tbody>
            </table>
