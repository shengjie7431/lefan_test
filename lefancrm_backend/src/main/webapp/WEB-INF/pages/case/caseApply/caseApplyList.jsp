...
<div class="main administrator">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/caseApply/caseApplyList" method="post">
                    <div class="form-group">
                        案件状态: <select name="state"  class="form-control">
                        <option value="" <c:if test="${state == ''}">selected="selected" </c:if>>全部</option>
                        <option value="0" <c:if test="${state == '0'}">selected="selected" </c:if>>报案</option>
                        <option value="1" <c:if test="${state == '1'}">selected="selected" </c:if>>受理</option>
                        <option value="2" <c:if test="${state == '2'}">selected="selected" </c:if>>转案件中心</option>
                    </select>
                    </div>
                        <%----%>
                    <div class="form-group">
                    ...
                    <div class="btn-group">
                        ...
                        &nbsp; &nbsp;<button onclick="caseApplyAlreadyList(4)" type="button" class="btn btn-default">咨询案件</button>&nbsp; &nbsp;
