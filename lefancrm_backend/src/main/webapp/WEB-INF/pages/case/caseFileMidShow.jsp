...
<body>
<div class="c_body" style="width:1080px">
    <!--轮播过程-->
    <div class="detail_context_pic" style="width:1080px">
        <div class="detail_context_pic_top" style="width:1080px">
            <!-- <div class="imgContainer"><img src="" alt="" id="pic1" curindex="0" /></div> -->
            <img src="" alt="" id="pic1" curindex="0" style="width:1080px"/>
...
<div id="pic2">
    ...
    <div class="p_content">
        <div class="p_img">
            <img src=""  id="pic2_img" data-flag="" curindex="" style="width:1080px"/>
        </div>
        <div class="toolsMax">
