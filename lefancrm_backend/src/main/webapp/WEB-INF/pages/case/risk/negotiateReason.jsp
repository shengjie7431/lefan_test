...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/case/risk/negotiateState" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <textarea  id = "reason" name="reason" style="width: 400px; height: 150px" class="form-control"></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
