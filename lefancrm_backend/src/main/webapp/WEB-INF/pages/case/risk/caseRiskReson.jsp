...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/case/risk/editRiskState" method="post">
        <div class="form-group">
            <table class="table">
                <tbody>
                <input type="hidden" id="id" name="id" value="${id}">
                <input type="hidden" id="state" name="state" value="${state}">
                <input type="hidden" id="riskType" name="riskType" value="${riskType}">
                <tr>
                    <th width="20%" class="active">驳回原因</th>
                    <td width="80%">
                        <textarea  id = "stateReason" name="stateReason" style="width: 400px; height: 150px" class="form-control"></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
