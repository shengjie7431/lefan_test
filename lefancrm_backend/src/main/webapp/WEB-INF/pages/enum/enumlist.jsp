...
<div class="panel panel-info">
	<div class="content_wrap">
		<div class="zTreeDemoBackground left">
			<ul id="treeDemo" class="ztree">正在加载枚举...</ul>
		</div>
        <%--<div style="border:5px solid red;width: 500px;height: 200px;float:left;">
...
<script type="text/javascript">
	...
	var setting = {
		async: {
			enable: true,
			url:"${ctx}/common/enum/enumtreeData",
    ...
    /*function zTreeOnClick(e, treeId, treeNode){
        ...
        alert(treeId+"88888888888"+treeNode.id);
    }*/
	...
	function onRemove(e, treeId, treeNode) {
		ajaxSubmit("${ctx}/common/enum/delete?id="+treeNode.id,{},null,"删除成功","",null);
		return false;
	}
	...
	function addHoverDom(treeId, treeNode) {
		...
		if (btn) btn.bind("click", function(){
			...
			var params = "parentId="+treeNode.id;
			alertDialog("添加枚举",params);
			return false;
		});
	};
	...
	function alertDialog(dialogTitle,params){
		openDialog({
		    ...
		    height:300,
		    width:700,
			url:"${ctx}/common/enum/edit?"+params
		});
	}
