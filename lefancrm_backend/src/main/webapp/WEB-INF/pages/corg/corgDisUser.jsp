...
<div class="main administrator">
    ...
    <div class="panel panel-info">
       ...
       <%-- <div class="panel-heading">
           ...
           <div class="panel-heading">
               <div class="pin">
                   <form class="form-inline" role="form" action="${ctx}/corg/queryNotDisUser" method="post">
                       <div class="form-group">
                       ...
                       <input type="hidden" value="${cOrgType}" name="cOrgType">
           ...
           <form id="editForm" role="form" action="${ctx}/corg/disUser" method="post">
    ...
    <div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/corg/queryNotDisUser?cOrgType=${cOrgType}&userName=${userName}&nickName=${nickName}&userTel=${userTel}&cOrgId=${cOrgId}" />
