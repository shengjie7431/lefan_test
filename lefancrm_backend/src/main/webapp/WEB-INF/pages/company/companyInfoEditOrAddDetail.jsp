        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%"><input class="form-control" required value="${infoDetail.title}" name="title"></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <textarea class="form-control" name="content" id="content" style="width: 720px;height: 700px;" >${infoDetail.content}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
