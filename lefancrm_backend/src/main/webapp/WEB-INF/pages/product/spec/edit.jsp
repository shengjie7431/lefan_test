...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/productSpec/edit" method="post">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%"><input required  name="specName" value="${item.specName}" class="form-control"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" value="${item.specPrice}"  id = "specPrice" name="specPrice" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>成本价</th>
                    <td width="80%">
                        <input type="text"  value="${item.specCost}"  id = "specCost" name="specCost" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>库存</th>
                    <td width="80%">
                        <input type="text"  value="${item.specStock}"  id = "specStock" name="specStock" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>销量</th>
                    <td width="80%">
                        <input type="text"  value="${item.specSales}"  id = "specSales" name="specSales" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
