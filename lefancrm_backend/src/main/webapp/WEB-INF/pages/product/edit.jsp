...
<body>
<div class="container">
	<form id="editForm" role="form" action="${ctx}/product/add" method="post">
	<div class="form-group">
		<table class="table">
	        <tbody>
	          <%--<tr>--%>
	            <%--<th width="20%" class="active"><strong class="necessary">*</strong>商品编号</th>--%>
	            <%--<td width="80%"><input type="text" class="form-control" name="productCode" placeholder="请输入商品编号" required="required"></td>--%>
	          <%--</tr>--%>
	          <tr>
	            <th class="active"><strong class="necessary">*</strong>商品名称</th>
	            <td><input type="text" class="form-control" id="productName" name="productName" placeholder="请输入商品名称" required="required"></td>
	          </tr>
	          <tr>
	            <th class="active"><strong class="necessary">*</strong>商品价格</th>
	            <td><input type="number" class="form-control" id="productPrice" name="productPrice" placeholder="请输入商品价格" required="required"></td>
	          </tr>
              <tr>
                  <th class="active"><strong class="necessary">*</strong>商品图片</th>
                  <td width="80%"><input required id="productPic" type="hidden" name="productPic">
              ...
              <tr>
                  ...
                  <td width="80%"><input required id="productMpic" type="hidden" name="productMpic">
                      <img id="infImgPic" width="80" height="80">
              ...
              <tr>
                  <td colspan="2">
                      <textarea name="productDis" id="productDis"></textarea>
                  </td>
              </tr>
              <tr>
                  <th class="active"><strong class="necessary">*</strong>商品优惠价格</th>
                  <td><input type="number" class="form-control" id="disPrice" name="disPrice" placeholder="请输入商品优惠价格" required="required"></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td><input type="text" class="form-control" id="unit" name="unit" placeholder="请输入计量单位" required="required"></td>
              </tr>
              <tr>
                  <th class="active"><strong class="necessary">*</strong>商品总库存</th>
                  <td><input type="number" class="form-control" id="stock" name="stock" placeholder="请输入商品总库存" required="required"></td>
              </tr>
              <tr>
                  <th class="active"><strong class="necessary">*</strong>排序</th>
                  <td><input type="text" class="form-control" id="sort" name="sort" placeholder="请输入排序" required="required"></td>
              </tr>
              <tr>
                  <th class="active"><strong class="necessary">*</strong>商品是否上架</th>
                  <td>
                      <select class="form-control"  name="isShelves" id="isShelves" required="required">
