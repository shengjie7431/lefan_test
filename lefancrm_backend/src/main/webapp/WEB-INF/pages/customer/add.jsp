...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/customer/add" method="post">
        <div class="form-group">
            <table class="table">
                <tbody>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>名称</th>
                    <td width="80%"><input required  name="name"  class="form-control"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" id = "phoneNumber" name="phoneNumber" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>联系人</th>
                    <td width="80%">
                        <input type="text" id = "linkUser" name="linkUser" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>详细地址</th>
                    <td width="80%">
                        <input type="text" id = "detailedLink" name="detailedLink" style="width: 400px;" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
