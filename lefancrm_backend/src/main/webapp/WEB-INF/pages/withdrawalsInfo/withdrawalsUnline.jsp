...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/withdrawalsInfo/withdrawalsUnlineSave" method="post">
        <input type="hidden" name="withdrawalsId" value="${withdrawalsId}">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input required id="adPic" type="hidden" value="${infoDetail.img}" name="unlineImg">
