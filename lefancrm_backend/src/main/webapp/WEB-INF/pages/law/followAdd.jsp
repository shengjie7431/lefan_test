...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/law/followSave" method="post">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><textarea name="followDesc" style="width: 220px;height: 100px" class="form-control" required="required"></textarea></td>
                </tr>
                <tr>
                    <th class="active"><strong class="necessary"> </strong>下次跟踪时间</th>
                    <td><input name="nextFollowTime"  style="width: 250px;" type="text"  class="form-control"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly ></td>
                </tr>
                </tbody>
            </table>
        </div>
