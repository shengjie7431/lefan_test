    ...
    <form id="editForm" role="form" action="${ctx}/law/operate" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <c:if test="${btnCode ==1503}">
                    <tr>
                        <th width="20%" class="active">催收备注</th>
                        <td width="80%">
                            <textarea  id = "collectionRemarks" required="required" name="collectionRemarks" style="width: 400px; height: 150px" class="form-control"></textarea>
                        </td>
                    </tr>
                </c:if>
                <c:if test="${btnCode !=1503}">
                    <tr>
                        ...
                        <td width="80%">
                            <textarea  id = "reason" required="required" name="reason" style="width: 400px; height: 150px" class="form-control"></textarea>
                        </td>
                    </tr>
                </c:if>
                </tbody>
