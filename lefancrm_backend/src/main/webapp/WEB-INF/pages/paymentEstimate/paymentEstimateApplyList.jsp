...
<html>
<head>
    <title>理赔测算申请列表</title>
    <%@ include file="/WEB-INF/pages/common/mainCss.jsp" %>
</head>
<body>
<div class="main administrator">
    <div class="main-top">
        <h3>理赔测算申请列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/paymentEstimate/paymentEstimateApplyList" method="post">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        <c:if test="${item.myAccidentLiability == 1}">全部责任</c:if>
...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/paymentEstimate/paymentEstimateApplyList" />
