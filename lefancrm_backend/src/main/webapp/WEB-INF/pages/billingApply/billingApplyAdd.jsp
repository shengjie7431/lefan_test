...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/billingApply/billingApplySave" method="post">
        ...
        <input type="hidden" name="billingSource" value="${billingSource}" />
        <%--未匹配收款 -- 认领--%>
        <input type="hidden" id="claim" name="claim" value="${claim}">
            ...
            <table class="table">
                <tbody>
                   ...
                   <tr>
                       ...
                       <td width="80%">
                           <input type="text" id="companyName" name="companyName" style="width: 320px; display: inline-block;" class="form-control" required="required" placeholder="可输入">
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <select name="billingItem" id="billingItem" class="form-control" style="width: 400px;" required="required">
                                <option value="">请选择</option>
                            </select>
                        </td>
                    </tr>
                    <%--<tr>--%>
                        <%--<th width="20%" class="active">开票类目</th>--%>
                        <%--<td width="80%">--%>
                            <%--<select name="billingEnum" id="billingEnum" class="form-control" style="width: 400px;" required="required" onchange="toBuildCaseNo()">--%>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" id="caseNo" name="caseNo" style="width: 400px;" class="form-control" readonly="true">
                        </td>
                    </tr>
                    <%--<tr>--%>
                        <%--<th width="20%" class="active">开票项目</th>--%>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" id="caseTitle" name="caseTitle" style="width: 400px;" class="form-control" required="required">
                        </td>
                    </tr>
                    <tr>
                        <th width="20%" class="active">开票金额</th>
                        <td width="80%">
                            <input type="number" step="0.01" id="billingMoney" name="billingMoney" value="${billingMoney}" style="width: 400px;" class="form-control" required="required"
                            <c:if test="${claim == 1}">readonly="true"</c:if>
                            >
                        </td>
                    </tr>
                   <tr>
                       ...
                       <td width="80%">
<%--                           <input type="number" step="0.01" id="taxRate" name="taxRate" value="${taxRate}" style="width: 400px;" class="form-control" required="required">--%>
...
<%--                        <th width="20%" class="active">发票收件人</th>--%>
<%--                        <td width="80%">--%>
<%--                            <input type="text" id="recipientsName" name="recipientsName" style="width: 320px; display: inline-block;" class="form-control" required="required" placeholder="可输入">--%>
<%--                            <input type="button" value="选  择" onclick="selectRecipient()"  style="width: 78px;  height: 32px;"/>--%>
<%--                        </td>--%>
<%--                    </tr>--%>
<%--                    <tr>--%>
<%--                        <th width="20%" class="active">收件人电话</th>--%>
<%--                        <td width="80%">--%>
<%--                            <input type="text" id="recipientsPhone" name="recipientsPhone" style="width: 400px;" class="form-control" required="required">--%>
<%--                        </td>--%>
<%--                    </tr>--%>
<%--                    <tr>--%>
<%--                        <th width="20%" class="active">收件人地址</th>--%>
...
<%--                        <th width="20%" class="active">收件人详细地址</th>--%>
<%--                        <td  width="80%">--%>
<%--                            <input type="text" id="address" name="address" style="width: 400px;" class="form-control" required="required">--%>
<%--                        </td>--%>
<%--                    </tr>--%>
                    <tr style="display: none">
<%--                        <th width="20%" class="active">绩效所属人员</th>--%>
<%--                        <td  width="80%">--%>
<%--                            <input type="text" id="meritName" name="meritName" value="${currentUserName}" style="width: 400px;" class="form-control" required="required">--%>
<%--                        </td>--%>
                        <th width="20%" class="active">绩效所属人员</th>
                        <td width="80%">
                    ...
                    <tr>
                        ...
                        <td  width="80%">
                            <input type="text" id="insuredName" name="insuredName" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th width="20%" class="active">车牌号</th>
                        <td  width="80%">
                            <input type="text" id="carNo" name="carNo" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th width="20%" class="active">伤者姓名</th>
                        <td  width="80%">
                            <input type="text" id="woundedName" name="woundedName" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td  width="80%">
                            <input type="text" id="policyNo" name="policyNo" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th width="20%" class="active">报案号</th>
                        <td  width="80%">
                            <input type="text" id="reportNo" name="reportNo" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <th width="20%" class="active">备注</th>
                        <td  width="80%">
                            <input type="textarea" id="remark" name="remark" style="width: 400px;" class="form-control">
                        </td>
                    </tr>
...
<script type="text/javascript">
    ...
    function aa(){
        $("#billingFileupload").attr("data-url","${ctx}/uploadImage?moduleName=ticket/"+caseNo);
    }
    //发票图片
    $('#billingFileupload').fileupload({
        done: function (e, data) {
            var r  = data.result;
            var img=r.images;
            var pathImg=img[0].userFilePath;
            if (r.success == true){
                $("#billingInfImg").attr("src","http://ddrapi.shlefan.com/sftp/files/"+pathImg);
                $("#billingAdPic").val("http://ddrapi.shlefan.com/sftp/files/"+pathImg);
            }else {
                alert("上传失败，请重试111");
            }
        }
