...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/billingApply/confirmAccountSubmit" method="post">
        <div class="form-group">
            <table class="table">
                <tbody>
                <input type="hidden" id="id" name="id" value="${id}">
                <input type="hidden" id="imgsId" name="imgsId" value="${imgsId}">
                <input type="hidden" id="noAccountMoney" name="noAccountMoney" value="${noAccountMoney}">
                <tr>
                    <th width="20%" class="active">到账金额</th>
                    <td>
                        <input type="number" id = "money" name="money" value="${noAccountMoney}"  step="0.01" min="0" class="form-control" required="required" max="${noAccountMoney}">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">到账时间</th>
                    <td>
                        <input name="confirmAccountTime" value="${nowDate.toString()}" type="text"  class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly>
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">到账凭证</th>
                    <td>
