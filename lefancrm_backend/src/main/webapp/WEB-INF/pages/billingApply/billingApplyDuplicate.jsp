...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/billingApply/billingApplySave" method="post">
        ...
        <input type="hidden" name="billingSource" value="2" />
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" id="caseNo" name="caseNo" value="" style="width: 400px;" class="form-control" readonly="true">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">案件标题</th>
                    <td width="80%">
                        <input type="text" id="caseTitle" name="caseTitle" value="" style="width: 400px;" class="form-control" required="required">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">开票金额</th>
                    <td width="80%">
                        <input type="number" step="0.01" id="billingMoney" name="billingMoney" value="" style="width: 400px;" class="form-control" required="required">
                    </td>
                </tr>
                <tr>
