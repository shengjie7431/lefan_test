    ...
    <form id="editForm" role="form" action="${ctx}/billingApply/billApplyStateUp" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <input type="hidden" id="billingState" name="billingState" value="1">
                <tr>
                    <th width="20%" class="active">驳回原因</th>
                    <td width="80%">
                        <textarea  id = "rejectReason" required="required" name="rejectReason" style="width: 400px; height: 150px" class="form-control"></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
