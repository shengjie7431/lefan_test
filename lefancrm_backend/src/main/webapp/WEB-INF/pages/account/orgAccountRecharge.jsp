...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/account/orgAccountRecharge" method="post">
        <input type="hidden" name="orgId" value="${orgId}">
        <div class="form-group">
            <table class="table">
                <tbody>
                <tr>
                    <th width="20%" class="active">充值金额</th>
                    <td width="80%">
                        <textarea  name="money" id="money"  style="width: 400px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary"> </strong>充值类型</th>
                    <td width="80%">
                        <select name="genre" class="form-control">
                            <option value="1">案件保证金</option>
