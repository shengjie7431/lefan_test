...
<div class="main administrator">
    ...
    <div class="panel panel-info">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${withdrawalsInfoDtoList}" var="item">
                <tr>
                    ...
                    <%--<td>
                        <c:if test="${item.state == 1}"><a href="javascript:getreport('${item.id}');">在线提现</a></c:if>
...
<script>
    ...
    function withdrawalsUnline(id){
        ajaxSubmit("${ctx}/account/withdrawalsUnline",{"id":id},reload,"提现成功","确认提现吗？");
    }
    function withdrawalsOnline(id){
        ajaxSubmit("${ctx}/account/withdrawalsOnline",{"id":id},reload,"提现成功","确认提现吗？");
    }
