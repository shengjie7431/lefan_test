...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/newsCategory/edit" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                       <input type="text" id = "catName" name="catName" value="${item.catName}"  style="width: 400px;" class="form-control">
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="80%">
                        <select id = "catType" name="catType"  style="width: 120px;" class="form-control">
                            <option value="1" <c:if test="${item.catType == 1}">selected="selected" </c:if>>新闻动态</option>
                            <option value="2" <c:if test="${item.catType == 2}">selected="selected" </c:if>>服务案例</option>
                            <option value="3" <c:if test="${item.catType == 3}">selected="selected" </c:if>>招聘信息</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="80%" class="form-inline">
                        ...
                        <input type="text" id = "catSort" name="catSort"  style="width: 50px;" class="form-control" value="${item.catSort}">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <input type="text" id = "catDesc" name="catDesc" value="${item.catDesc}" style="width: 400px;" class="form-control" >
                    </td>
                </tr>
                </tbody>
            </table>
