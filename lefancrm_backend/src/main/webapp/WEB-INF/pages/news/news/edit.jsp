...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/news/edit" method="post">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%"><input required value="${item.title}" id="title" name="title"  class="form-control"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%">
                        <select id = "subType"   style="width:120px;" onclick="queryCat()" class="form-control">
                            <option value="${item.catId}">${item.newsCategory.catName}</option>
                        </select>
                        <input id="catId" name="catId" type="hidden" class="form-control" value="${item.catId}">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary">*</strong>是否公开</th>
                    <td width="80%">
                        <select name="isPublish" required class="form-control"  style="width:120px;">
                            <option value="1" <c:if test="${item.isPublish == 1}">selected="" </c:if>>是</option>
                            <option value="2" <c:if test="${item.isPublish == 2}">selected="" </c:if>>否</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <input name="publishTime" type="text" value="<fmt:formatDate value="${item.publishTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"  class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%">
                        <%--<input type="text" id = "outline" name="outline" value="${item.outline}" class="form-control">--%>
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="context" id="context"  class="form-control">${item.context}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
