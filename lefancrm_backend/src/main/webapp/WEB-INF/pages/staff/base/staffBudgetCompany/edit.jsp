            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        <select class="form-control" required="required" name="state" id="organType">
                            <option value="0" <c:if test="${staffCompany.state == 0}"> selected="selected" </c:if>>启用</option>
                            <option value="1" <c:if test="${staffCompany.state == 1}"> selected="selected" </c:if>>停用</option>
                        </select>
                    </td>
                </tr>
                </tbody>
