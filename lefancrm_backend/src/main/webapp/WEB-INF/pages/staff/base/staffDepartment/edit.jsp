...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/staff/update" method="post">
        ...
        <input type="hidden" name="id" id="id" value="${staffDepartment.id}">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id = "name" name="name" value="${staffDepartment.name}" required="required" onblur="selectName('${staffDepartment.id}',2000,this)" class="form-control">
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="70%">
                        ...
                        <select class="form-control" required="required" name="state" id="state">
                            <option value="0" <c:if test="${staffDepartment.state == 0}"> selected="selected" </c:if>>启用</option>
                            <option value="1" <c:if test="${staffDepartment.state == 1}"> selected="selected" </c:if>>停用</option>
                        </select>
                    </td>
                </tr>
                </tbody>
