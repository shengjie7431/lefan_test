...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/staff/update" method="post">
        ...
        <input type="hidden" name="id" id="id" value="${staffBusinessUnit.id}">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id = "name" name="name" value="${staffBusinessUnit.name}" autocomplete="off" class="form-control" required="required" >
                    </td>
                </tr>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    function selectName(businessUnitId,btnCode,name){
        if(name ==null || name==""){
            return;
        }
        ajaxSubmit("${ctx}/staff/selectStaffInfoByRelationId",{"businessUnitId":businessUnitId,"surveyCode":'${surveyCode}',"btnCode":btnCode,"name":name},function(v,e,p){
