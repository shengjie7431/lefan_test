...
<script>
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate', 'layer'], function () {
        ...
        form.on('submit(submit)', function (data) {
            paramSubmit = {
                socialSecurityCompanyIds: demo1.getValue('valueStr'),
                organIds: demo2.getValue('valueStr'),
                departmentIds: demo3.getValue('valueStr'),
                teamIds: demo4.getValue('valueStr'),
                startTime: $('#startTime').val(),
                endTime: $('#endTime').val(),
                surveyCode: 'personnelCostAnalysis',
                dataCode: 'personnelCostAnalysis'
            }
        ...
        var _cols = [
            [ {
                ...
                field: 'personnelCostSub',
                width: 140,
                title: '人工成本总额',
                totalRow: true,
            },{
                field: 'monthBeginPersonnelNum',
                width: 120,
                title: '期初人数',
                totalRow: true,
            },{
                field: 'monthEndPersonnelNum',
                width: 120,
                title: '期末人数',
                totalRow: true,
            },{
                field: 'quitPersonnelNum',
                width: 120,
                title: '离职人数',
                totalRow: true,
            },{
        ...
        function setTable(_cols, param) {
            ...
            var myTable = table.render({
                ...
                parseData: function (res) {
                    return {
                        ...
                        "totalRow": {
                            "monthBeginPersonnelNum": res.results.personnelInfo.monthBeginPersonnelNum || '0',


                            "wagesPaySub": res.results.personnelInfo.wagesPaySub || '0',
                            "fixedPerfPay": res.results.personnelInfo.fixedPerfPay || '0',
                            "assesPerfPay": res.results.personnelInfo.assesPerfPay || '0',
                            "travelAllowancePay": res.results.personnelInfo.travelAllowancePay || '0',
                            "integralPay": res.results.personnelInfo.integralPay || '0',
                            "welfarePay": res.results.personnelInfo.welfarePay || '0',
                            "quitCost": res.results.personnelInfo.quitCost || '0',
                            "companyMoneySub": res.results.personnelInfo.companyMoneySub || '0',
                            "personnelCostSub": res.results.personnelInfo.personnelCostSub || '0',




                            "monthEndPersonnelNum": res.results.personnelInfo.monthEndPersonnelNum || '0',
                            "quitPersonnelNum": res.results.personnelInfo.quitPersonnelNum || '0',
                            "quitRate": getRate(res.results.personnelInfo.quitRate) || '0',
                            "personnelNum": res.results.personnelInfo.personnelNum || '0'
                        }
                    }
                },
                initSort: {
            ...
            table.on('tool(test)', function (obj) {
                if (obj.event =='persons'){
                    showCaseList({
                        socialSecurityCompanyId: obj.data.socialSecurityCompanyId,
                        organId: obj.data.organId,
                        departmentId: obj.data.departmentId,
                        teamId: obj.data.teamId,
                        workTime: obj.data.workTime,
                        surveyCode: 'personnelCostAnalysisUser',
                        dataCode: 'personnelCostAnalysisUser'
                    })
                }
