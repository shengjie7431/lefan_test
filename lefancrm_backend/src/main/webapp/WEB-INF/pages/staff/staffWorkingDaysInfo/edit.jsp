...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/staff/update" method="post">
        ...
        <input type="hidden" name="id" id="id" value="${staffWorkingDaysInfo.id}">
        <input type="hidden" name="lastWorkTime" id="lastWorkTime" value="${lastWorkTime}">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input id="workTime" name="workTime" type="text" class="form-control" required="required" style="cursor: pointer"
                               value="${staffWorkingDaysInfo.workTime}" onclick="WdatePicker({dateFmt:'yyyy-MM'})" readonly>
                    </td>
                </tr>
                <tr>
                    <th width="30%" class="active">上班天数</th>
                    <td width="70%">
                        <input type="number" min="0" step="0.1" id = "wrokingDays" name="wrokingDays" value="${staffWorkingDaysInfo.wrokingDays}"  class="form-control" required="required">
                    </td>
                </tr>
                </tbody>
            </table>
