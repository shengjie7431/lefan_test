...
<div class="main administrator">
    <div class="main-top">
        <h3>岗位职级 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/staff/staffpostrank/list" method="post">
                    <input type="hidden" name="pageSize" id="pageSize" value="${pageSize}" />
                    <div class="form-group">
                        岗位职级:
                        <input name="rankName" type="text" value="${rankName}" style="width: 150px" class="form-control" >
                    </div>
                    <div class="form-group">
                        状态:
    ...
    <div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/staff/staffpostrank/list?rankName=${rankName}" />
...
<script>
    ...
    var edit = function(id){
        openDialog({
            ...
            height:500,
            width:800,
            url:"${ctx}/staff/staffpostrank/staffPostRankDetails?id="+id
        });
    }
