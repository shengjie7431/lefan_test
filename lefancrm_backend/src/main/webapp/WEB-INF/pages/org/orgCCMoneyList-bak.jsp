                ...
                <div class="panel-heading">
                    <div class="pin">
                        <form class="form-inline" role="form" action="${ctx}/case/caseCenterInfoList" method="post">
                            跟进开始时间： <input name="startTime" type="text" value="${startTime}" class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly>
                            跟进结束时间： <input name="endTime" type="text" value="${endTime}" class="form-control" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly>
