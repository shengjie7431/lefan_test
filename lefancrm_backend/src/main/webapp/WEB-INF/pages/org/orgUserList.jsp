...
<div class="main administrator">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/org/queryUser" method="post">
   ...
   <%-- <div class="panel-heading">
    ...
    <div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/org/queryUser?id=${id}&userName=${userName}&nickName=${nickName}&userTel=${userTel}" />
