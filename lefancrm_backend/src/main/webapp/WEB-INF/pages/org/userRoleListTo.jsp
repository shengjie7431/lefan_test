            ...
            <div class="content_wrap">
                <div class="">
                    <div class="zTreeDemoBackground left">
                        <ul id="treeDemo" class="ztree">正在加载保险公司...</ul>
                    </div>
                </div>
            </div>
        </div><!--panel-info-->
...
var setting = {
    async: {
        enable: true,
        url:"${ctx}/org/treeData?orgType=2",
...
function onAsyncSuccess(){
    ...
    <%--ajaxSubmit("${ctx}/org/treeDataOrg",null,function(v,e,p){--%>
    <%--alert(22222);--%>
    <%--if(e.data.code==='0000'){--%>
    <%--var data = "";--%>
    ...
    <%--caozuo += "<a  href='javascript:void(0)'' onclick='queryCase("+json.id+")'>查看案件</a>";--%>
    <%--caozuo +=" ";--%>
    <%--caozuo += "<a  href='javascript:void(0)' onclick='queryUser("+json.id+","+json.orgParentid+")'>查看用户</a>";--%>
    <%--}else if(json.state == 3){--%>
    <%--states = "审核不通过";--%>
    <%--caozuo +=" ";--%>
    <%--caozuo += "<a  href='javascript:void(0)' onclick='updateState("+json.id+",2,5)'>重新审核</a>";--%>
