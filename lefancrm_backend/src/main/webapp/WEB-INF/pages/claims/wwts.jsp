    ...
    <div class="layui-form searchs" lay-filter="search">
        <div class="layui-form-item ">
            <div class="layui-inline">
                <label class="layui-form-label">驾驶员姓名
                </label>
                <div class="layui-input-inline _input">
                    <input type="text" name="driverName" placeholder="请输入联系人姓名"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">驾驶员电话
                </label>
                <div class="layui-input-inline _input">
                    <input type="number" name="driverTel" placeholder="请输入手机号"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">伤者姓名
                </label>
                <div class="layui-input-inline _input">
                    <input type="text" name="injuredName" placeholder="请输入联系人姓名"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">伤者电话
                </label>
                <div class="layui-input-inline _input">
                    <input type="number" name="injuredTel" placeholder="请输入手机号"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate', 'layer'], function () {
        ...
        form.on('submit(submit)', function (data) {
            Object.assign(paramSumbit, {
                ...
                driverTel: $('input[name=driverTel]').val(),
                injuredName: $('input[name=injuredName]').val(),
                injuredTel: $('input[name=injuredTel]').val(),
