        ...
        <div class="layui-form-item ">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline _input">
                    <input type="text" name="linkName" placeholder="请输入联系人姓名"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="d-flex-wrap">
                    ...
                    <div class="d-flex-wrap">
                        <div class="data-choose">
                            <input type="text" class="layui-input accidentStartTime" readonly id="accidentStartTime"
                                   placeholder="请选择日期">
                            <span class="dc-span">至</span>
                            <input type="text" class="layui-input accidentEndTime" readonly id="accidentEndTime"
                                   placeholder="请选择日期">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate', 'layer'], function () {
        ...
        demo1.setValue(['0'])
        accidentStartTime = laydate.render({
            elem: '#accidentStartTime',
            done: function (value, date) {
                accidentEndTime.config.min = {
                    year: date.year,
                    month: date.month - 1,
                    date: date.date
                }
        ...
        accidentEndTime = laydate.render({
            elem: '#accidentEndTime',
            done: function (value, date) {
                if (value) {
                    accidentStartTime.config.max = {
                        year: date.year,
                        month: date.month - 1,
                        date: date.date
                    }
        ...
        form.on('submit(submit)', function (data) {
            Object.assign(paramSumbit, {
                ...
                accidentStartTime: $('#accidentStartTime').val(),
                accidentEndTime: $('#accidentEndTime').val(),
                handleState: demo1.getValue('valueStr'),
        ...
        var _cols = [
            [{
                ...
                title: '事故时间',
                templet: function (d) {
                    return d.accidentTime ? layui.util.toDateString(d.accidentTime, 'yyyy-MM-dd HH:mm') : ''
                }
            },{
                field: 'accidentAddress',
                minWidth: 150,
                title: '事故地点',
            },{
                field: 'accidentDesc',
