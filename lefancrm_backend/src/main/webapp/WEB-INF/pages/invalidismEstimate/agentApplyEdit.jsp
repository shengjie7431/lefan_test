        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                       <input type="text" id = "userName" name="userName"  style="width: 400px;" value="${agent.userName}">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">用户手机号</th>
                    <td width="80%">
                        <input type="text" id = "userPhone" name="userPhone" style="width: 400px;" value="${agent.userPhone}">
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active">代理类型</th>
                    <td width="80%">
                        <select id = "agentType" name="agentType"  style="width: 75px;">
                ...
                <tr>
                    ...
                    <td width="30%">
                    省
                        <select id = "accidentProvinceId" name="accidentProvinceId"  style="width: 75px;"  onclick="selectArea()">
                    ...
                    市
                        <select id = "accidentCityId" name="accidentCityId"  style="width: 75px;" onclick="selectAreaCity()">
                            <option value="${agent.accidentCityId}">${agent.accidentCity}</option>
                        </select>
                    区
                        <select id = "accidentDistrictId" name="accidentDistrictId"  style="width: 75px;">
                ...
                <tr>
                    <th width="20%" class="active">事故发生详细地址</th>
                    <td width="80%">
                        <input type="text" id = "accidentAddress" name="accidentAddress" style="width: 400px;"value="${agent.accidentAddress}">
                    </td>
                </tr>
                </tbody>
            </table>
