    ...
    <div class="detail_context_pic">
        ...
        <div class="detail_context_pic_bot">
            ...
            <div class="detail_picbot_mid">
                <ul>
                    <c:forEach items="${invalidismEstimateFile}" var="file">
                        <li>
                            <a href='javascript:void(0);'> <img src='http://openapi.shlefan.com/pic/images${file.filePath}' width='90px' height='60px'  bigimg='http://openapi.shlefan.com/pic/images${file.filePath}' /> </a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
