...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/baseSurvey/update" method="post">
        <input type="hidden" name="id" value="${surveyConsignorDepartment.id}">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id = "name" name="name" value="${surveyConsignorDepartment.name}" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="30%" class="active">排序</th>
                    <td width="70%">
                        <input type="text" id = "sort" name="sort" value="${surveyConsignorDepartment.sort}" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
