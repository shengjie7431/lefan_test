...
<div class="container">
    <form id="editForm">
        <input type="hidden" name="id" value="${efficiencyModelArea.id}">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="90%">
                        <input type="text" id = "name" name="name" value="${efficiencyModelArea.name}" class="form-control" required>
                    </td>
                </tr>
                <tr>
                ...
                success: function () {
                    $.ajax({
                        ...
                        data:{
                            ...
                            surveyCode:"commonAreaEfficiency",
                            btnCode:"2000",
                            modelId:$("input[name=modelId]").val()
                        },
