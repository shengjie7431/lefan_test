...
<script>
    ...
    $(function(){
        $('.class-list').on('blur','input',function(){
            ...
            ajaxSubmit("${ctx}/baseSurvey/operate",{"modelId":modelId,"surveyCode":"scoreModel",
                "btnCode":1000,"price":price,"areaCategoriesId":areaCategoriesId},null,null);
        })
    })
