...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/baseSurvey/update" method="post">
        <input type="hidden" name="id" value="${channelModelArea.id}">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="90%">
                        <input type="text" id = "name" name="name" value="${channelModelArea.name}" class="form-control" required>
                    </td>
                </tr>
                <tr>
            ...
            layerIndex2 = layer.open({
                ...
                success: function () {
                    $.ajax({
                        ...
                        data:{
                            areaId:areaId,
                            channelModelCaId: $("input[name=id]").val(),
                            surveyCode:"commonAreaChannel",
                            btnCode:"2000",
