    ...
    <div class="panel panel-info">
        <form id="editForm" role="form" action="${ctx}/baseSurvey/operate" method="post">
            ...
            <table class="table table-hover">
                <thead>
                <button onclick="add('${id}','channelModelArea')" type="button" class="btn btn-default">添加区域类别</button>
                <button onclick="addPrice('${id}','channelModePrice','${type}')" type="button" class="btn btn-default">设置价格</button>
                <tr>
                ...
                <c:forEach items="${infos}" var="item">
                    <tr>
                        ...
                        <td>
                            <a href="javascript:operate('${item.id}','channelModelArea','1000',false);">修改</a>

                            <a href="javascript:operate('${item.id}','channelModelAreaDel','9999',true);">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
