        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id = "catalogName" name="catalogName" value="${surveyFileCatalog.catalogName}" class="form-control">
                    </td>
                </tr>
                <tr>
                    <th width="30%" class="active">描述</th>
                    <td width="70%">
                       <textarea id = "catalogText" name="catalogText"  style="height: 200px;" class="form-control">${surveyFileCatalog.catalogText}</textarea>
                    </td>
                </tr>
