    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate'], function () {
        ...
        var _cols = [
            ...
            [
            {
                ...
                totalRow: true,
                templet: function (d) {
                    var _d = Math.round(d.yw2Rate * 10000) / 100
                    var _html = '<div class="">' + _d + '%</div>'
                    // if (_d > 0) {
                    //     _html = '<div class="color1">+' + _d + '%</div>'
                    // } else if (_d < 0) {
        ...
        function setTable(_cols, param) {
            ...
            var myTable = table.render({
                ...
                parseData: function (res) {
                    resultsTotal= {
                        "yw2Rate": getRate(res.results.total.yw2Rate),
                    ...
                    return {
                        ...
                        "totalRow": {
                            ...
                            "yw2Rate": getFixed(res.results.total.yw2Rate),
                    ...
                    if (resultsTotal.yw2Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="yw2Rate"] div').addClass('color2')
                    }else if (resultsTotal.yw2Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="yw2Rate"] div').addClass('color1')
                    }
