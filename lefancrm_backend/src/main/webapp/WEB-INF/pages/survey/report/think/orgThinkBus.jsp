...
<script>
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate'], function () {
        ...
        var newProJson = [{proId: -100, proName: "互助+保司"}]
        newProJson = newProJson.concat(proThinksJson)
        filterJson(demo1,newProJson,'proId','proName',false,false)
        ...
        form.on('submit(submit)', function (data) {
            Object.assign(paramSubmit, {
                ...
                staffType: demo3.getValue('valueStr'),
                reType: demo4.getValue('valueStr'),
            })
