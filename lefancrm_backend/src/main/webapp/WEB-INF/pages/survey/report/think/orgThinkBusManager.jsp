    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate'], function () {
        ...
        var _cols = [
            [
                ...
                },
                {
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round((d.outMoney + d.inMoney) * 100) / 100
                    }
                },
                {
                    field: 'cwMoney',
        ...
        function setTable(_cols, param) {
            ...
            var myTable = table.render({
                ...
                parseData: function (res) {
                    return {
                        ...
                        "totalRow": {
                            "allMoney": getFixed(res.results.total.inMoney + res.results.total.outMoney),
            ...
            table.on('tool(test)', function (obj) {
                if (obj.event == 'market') {
                    var newData = {}
                    Object.assign(newData,obj.data.outDetail,obj.data.detail)
                    var _colsChild = [
                        [
                            {
                                field: 'gzMoney1',
