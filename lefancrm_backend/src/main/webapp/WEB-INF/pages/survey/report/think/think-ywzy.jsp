...
<script>
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate'], function () {
            ...
            [
                {
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.yw1 * 100) / 100
                    }
                },{
                    field: 'yw2',
                    minWidth: 170,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.yw2 * 100) / 100
                    }
                },{
                    field: 'yw3',
                    minWidth: 180,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.yw3 * 100) / 100
                    }
                },{
                    field: 'yw4',
                    minWidth: 180,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.yw4 * 100) / 100
                    }
                },{
                    field: 'yw5',
                    minWidth: 210,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.yw5 * 100) / 100
                    }
                },{
                    field: 'yw6Rate',
                    minWidth: 210,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        var _d = Math.round(d.yw6Rate * 10000) / 100
                        var _html = '<div class="">' + _d + '%</div>'
                        // if (_d > 0) {
                        //     _html = '<div class="color1">+' + _d + '%</div>'
                        // } else if (_d < 0) {
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.sr1 * 100) / 100
                    }
                },{
                    field: 'sr2Rate',
                    minWidth: 210,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        var _d = Math.round(d.sr2Rate * 10000) / 100
                        var _html = '<div class="">' + _d + '%</div>'
                        // if (_d > 0) {
                        //     _html = '<div class="color1">+' + _d + '%</div>'
                        // } else if (_d < 0) {
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.sr7 * 100) / 100
                    }
                },{
                    field: 'sr8',
                    minWidth: 130,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.sr8 * 100) / 100
                    }
                },{
                    field: 'sr9',
                    minWidth: 130,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.sr9 * 100) / 100
                    }
                },{
                    field: 'sr10',
                    minWidth: 130,
                    ...
                    totalRow: true,
                    templet: function (d) {
                        return Math.round(d.sr10 * 100) / 100
                    }
                },
                // {
                //     field: 'sr11',
                ...
                //     totalRow: true,
                //     templet: function (d) {
                //         return Math.round(d.sr11 * 100) / 100
                //     }
                // },
                {
                field: 'zc1',
                ...
                totalRow: true,
                templet: function (d) {
                    return Math.round(d.lr3 * 100) / 100
                }
            }, {
                field: 'lr3Rate',
                minWidth: 120,
                ...
                totalRow: true,
                templet: function (d) {
                    var _d = Math.round(d.lr3Rate * 10000) / 100
                    var _html = '<div class="">' + _d + '%</div>'
                    // if (_d > 0) {
                    //     _html = '<div class="color1">+' + _d + '%</div>'
                    // } else if (_d < 0) {
        ...
        var orgManager = $('#orgManager').val() == 'true' ? true : false
        ...
        function setTable(_cols, param) {
            ...
            var myTable = table.render({
                ...
                parseData: function (res) {
                    resultsTotal= {
                        "yw6Rate": getRate(res.results.total.yw6Rate),
                        "sr2Rate": getRate(res.results.total.sr2Rate),
                    ...
                    return {
                        ...
                        "totalRow": {
                            "yw1": getFixed(res.results.total.yw1),
                            "yw2": getFixed(res.results.total.yw2),
                            "yw3": getFixed(res.results.total.yw3),
                            "yw4": getFixed(res.results.total.yw4),
                            "yw5": getFixed(res.results.total.yw5),
                            "yw6Rate": getRate(res.results.total.yw6Rate),
                            "sr1": getFixed(res.results.total.sr1),
                            "sr2Rate": getRate(res.results.total.sr2Rate),
                            "sr3": getFixed(res.results.total.sr3),
                            "sr4": getFixed(res.results.total.sr4),
                            "sr5": getFixed(res.results.total.sr5),
                            "sr6Rate": getRate(res.results.total.sr6Rate),
                            "sr7": getFixed(res.results.total.sr7),
                            "sr8": getFixed(res.results.total.sr8),
                            "sr9": getFixed(res.results.total.sr9),
                            "sr10": getFixed(res.results.total.sr10),
                            "sr11": getFixed(res.results.total.sr11),
                            ...
                            "lr2Rate": getRate(res.results.total.lr2Rate),
                            "lr3": getFixed(res.results.total.lr3),
                            "lr3Rate": getRate(res.results.total.lr3Rate),
                    ...
                    if (resultsTotal.yw6Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="yw6Rate"] div').addClass('color2')
                    }else if (resultsTotal.yw6Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="yw6Rate"] div').addClass('color1')
                    }
                    if (resultsTotal.sr2Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="sr2Rate"] div').addClass('color2')
                    }else if (resultsTotal.sr2Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="sr2Rate"] div').addClass('color1')
                    }
                    if (resultsTotal.sr6Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="sr6Rate"] div').addClass('color2')
                    }else if (resultsTotal.sr6Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="sr6Rate"] div').addClass('color1')
                    }
