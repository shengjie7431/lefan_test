...
<script>
    ...
    function initData() {
        ...
        var param = {"dataType":"project","dataTable":"bas"};
        ...
        ajaxSubmit(url,param,function(v,e,p){
            if(e.data.code==='0000'){
                ...
                if(bas){
                    ...
                    html += '<div class="keybar caseList" data-index="4" data-type="tar"><div class="name">开票</div><div class="num">0元</div></div>';
                    html += '<div class="keybar" data-index="5" data-type="tar"><div class="name">到账</div><div class="num">0元</div></div>';
    ...
    function addSurveyPage(orgId,type){
        ...
        if (type == 1){
            parent.addTab("保司报表","${ctx}/survey/report/index?menuCode=entrust&menuCode2=project&entrustOrgId=" + orgId + "&searchType=" + searchType + "&startTime=" + startTime + "&endTime=" + endTime,true);
        } else{
            parent.addTab("机构报表","${ctx}/survey/report/index?menuCode=org&menuCode2=project&surveyOrgId=" + orgId + "&searchType=" + searchType + "&startTime=" + startTime + "&endTime=" + endTime,true);
        }
    }
    ...
    function searchOrg(type){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable" : type == 1 ? "searchEntrust" : "searchSurvey"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        param["tbStartTime"] = $("#tbStartTime").val();
    ...
    function initBusiness(){
        ...
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"business"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        ajaxSubmit(url,param,function(v,e,p){
    ...
    function initTask(loadNext){
        ...
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"task"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
    ...
    function initCross(){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"cross"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        ajaxSubmit(url,param,function(v,e,p){
    ...
    function initArea(){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"area"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        ajaxSubmit(url,param,function(v,e,p){
    ...
    function initService(){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"service"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        ajaxSubmit(url,param,function(v,e,p){
    ...
    function initAttr(){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"attr"};
        param["searchType"] = searchType;
        param["startTime"] = $("#startTime").val();
        param["endTime"] = $("#endTime").val();
        ajaxSubmit(url,param,function(v,e,p){
    ...
    function initTrend(){
        var searchType = $("#searchType").val();
        var url = "${ctx}/survey/report/getData";
        var param = {"dataType":"project","dataTable":"trend"};
