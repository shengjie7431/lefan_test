...
<div class="main administrator">
    <div class="main-top">
        <h3>报告模板列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/baseSurvey/list" method="post">
                   ...
                   <div class="form-group">
                       模板名称:<input name="name" type="text" value="${name}" class="form-control">
                   </div>
                    <div class="btn-group">
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        <a href="javascript:oper('${item.id}','${item.name}','consignorModel','1000','设置委托方');">设置委托方</a>
                        <a href="javascript:oper('${item.id}','','consignorModel','1100','名下委托方');">名下委托方</a>
