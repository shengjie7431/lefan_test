...
<div class="main administrator">
    <div class="main-top">
        <h3>服务区域介绍 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
    ...
    <div class="panel panel-info">
        ...
        <table class="table table-hover">
            ...
            <tr>
                <th width="100">名称</th>
                <th width="100">区域类型</th>
                <th width="250">区域名称</th>
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    <td>${item.name}</td>
                    <td>
                        <c:if test="${item.type==1}">省</c:if>
                        <c:if test="${item.type==2}">市</c:if>
                        <c:if test="${item.type==3}">区</c:if>
                    </td>
                    <td>${item.areaName}</td>
