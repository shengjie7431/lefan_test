...
<div class="main">
    <input type="hidden" name="id" value="${surveyCommonAreaPrice.areaId}">
    <input type="hidden" name="surveyCode" value="${surveyCode}">
    <div class="title">
        <button class="butList active" onclick="operate('${surveyCommonAreaPrice.areaId}','${surveyCommonAreaPrice.cityType}','${surveyCommonAreaPrice.taskId}','${surveyCode}','1000',false);">修改</button>
        <button class="butList defuelt" onclick="operate('${surveyCommonAreaPrice.areaId}','${surveyCommonAreaPrice.cityType}','${surveyCommonAreaPrice.taskId}','${surveyCode}','9999',true);">删除</button>
    ...
    <div class="main-boy">
        <div>
            <table class="spec-info" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>区域名称</td>
                    <td>${surveyCommonAreaPrice.areaName}</td>
                    <td>任务类型名称</td>
                    <td>${surveyCommonAreaPrice.taskName}</td>
                    <td>区域类别</td>
                    <td>
                ...
                <tr>
                    <td>区域价格</td>
                    <td colspan="5">${surveyCommonAreaPrice.price}</td>
