...
<html>
<head>
    <title>开票产品类型列表</title>
    <%@ include file="/WEB-INF/pages/common/mainCss.jsp" %>
</head>
<body>
<div class="main administrator">
    <div class="main-top">
        <h3>开票产品类型列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:addOrg('${item.id}','${surveyCode}',1100);">设置业务来源</a>
                        <a href="javascript:addOrg('${item.id}','${surveyCode}',1200);">名下业务来源</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script>
    ...
    var addOrg = function(productId,surveyCode,btnCode){
        openDialog({
            frame:true,
            title:"业务来源数据",
            height:800,
            width:1200,
            url:"${ctx}/baseSurvey/popup?surveyCode="+surveyCode+"&productId="+productId+"&btnCode="+btnCode
        });
    }
</script>
</body>
