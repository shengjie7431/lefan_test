...
<div class="main administrator">
    <div class="main-top">
        <h3>开票公司列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:addEnum('${item.id}','${surveyCode}',1100);">设置产品</a>
                        <a href="javascript:addEnum('${item.id}','${surveyCode}',1200);">名下产品</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script>
    ...
    var addEnum = function(applyCorporationId,surveyCode,btnCode){
        openDialog({
            frame:true,
            title:"产品数据",
            height:800,
            width:1200,
            url:"${ctx}/baseSurvey/popup?surveyCode="+surveyCode+"&applyCorporationId="+applyCorporationId+"&btnCode="+btnCode
        });
    }
</script>
</body>
