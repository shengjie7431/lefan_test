...
<div class="main administrator">
    <div class="main-top">
        <h3>开票产品列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        <a href="javascript:addItem('${item.enumCode}','applyCorporationEnum',1100);">设置项目</a>
                        <a href="javascript:addItem('${item.enumCode}','applyCorporationEnum',1200);">名下项目</a>
...
<script>
    ...
    var edit = function(id,surveyCode){
        openDialog({
            frame:true,
            title:"详情",
            height:800,
    ...
    var addItem = function(billingEnumId,surveyCode,btnCode){
        openDialog({
            frame:true,
            title:"项目数据",
            height:650,
            width:1000,
            url:"${ctx}/baseSurvey/popup?surveyCode="+surveyCode+"&btnCode="+btnCode+"&billingEnumId="+billingEnumId
        });
    }
</script>
</body>
