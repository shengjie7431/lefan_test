...
<div class="main administrator">
    ...
    <div class="panel panel-info" style="margin: 0 2px 15px 2px">
        ...
        <table class="table table-hover"  style="border-right:1px solid #000000;border-bottom:1px solid #000000">
            ...
            <c:forEach items="${surveyInvestigatorAreaPrice2Dtos}" var="item">
                <tr class="frame">
                    ...
                    <td width="4%" class="frame" style="vertical-align:middle;">
                        ...
                        <a href="javascript:updatePrice('${surveyCode}','${item.areaId}','1300','${item.cityType}','${item.areaName}','${item.priceType}');">修改</a><br>
                        <a href="javascript:deletePrice('${item.areaId}','${surveyCode}','9999','${item.priceType}')">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/baseSurvey/list?surveyCode=${surveyCode}&areaName=${areaName}&taskId=${taskId}&cityType=${cityType}&priceType=${priceType}" />
...
<script>
    ...
    //合并单元格
    mc(0,${surveyInvestigatorAreaPrice2Dtos.size()},0);
