...
<%--                    <td width="80%">--%>
<%--                        <input type="text" id="parentName" name="parentName" value="${surveyFranchisee.parentName}" style="width: 420px; display: inline-block;" class="form-control" readonly>--%>
<%--                        <input type="hidden" id="parentId" name="parentId">--%>
<%--                        <input type="button" value="选  择" onclick="selectFranchisee('${surveyCode}')"  style="width: 58px;  height: 32px;"/>--%>
<%--                    </td>--%>
<%--                </tr>--%>
                <tr>
...
<%--                    <td width="70%">--%>
<%--                        <input type="number" step="0.01" id = "deepCasesPrice" name="deepCasesPrice" value="1200"  class="form-control">--%>
<%--                    </td>--%>
<%--                </tr>--%>
<%--                <tr>--%>
...
<%--                    <td>--%>
<%--                        <div>--%>
<%--                            <input type="hidden" id="acceptUserIdcardUrl" name="acceptUserIdcardUrl" value="" />--%>
<%--                            <div id="idcardUrlDiv" style="display: none"></div>--%>
<%--                            <div id="idcardUrlDeleteDiv" style="display: none">--%>
...
<%--                    <td>--%>
<%--                        <div>--%>
<%--                            <input type="hidden" id="bankUrl" name="bankUrl" value="" />--%>
<%--                            <div id="bankUrlDiv" style="display: none"></div>--%>
<%--                            <div id="bankUrlDeleteDiv" style="display: none">--%>
