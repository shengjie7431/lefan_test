...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/baseSurvey/operate" method="post">
        <div class="form-group">
            <table class="table">
                <tbody>
                <input type="hidden" id="id" name="id" value="${surveyConsigner.id}">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <select class="form-control" required="required" style="display: inline-flex" name="departmentId" id="departmentId">
