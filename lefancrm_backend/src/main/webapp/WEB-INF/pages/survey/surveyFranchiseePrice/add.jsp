        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id="franchiseeName" name="franchiseeName"  value="${franchiseeName}" class="form-control" readonly>
...
<%--<div class="main administrator">--%>
    ...
    <%--<div class="panel panel-info">--%>
        ...
        <%--</div>--%>
        <%--<form id="editForm" role="form" action="${ctx}/surveyFranchiseePrice/getShowArea" method="post">--%>
            <%--<input type="hidden" name="surveyCode" value="${surveyCode}">--%>
...
<%--//        location.reload();--%>
    ...
    <%--function add(areaId,taskId,taskName){--%>
        ...
        <%--if(!price){--%>
            <%--return;--%>
        <%--}--%>
        <%--ajaxSubmit("${ctx}/baseSurvey/operate",{"areaId":areaId,"taskId":taskId,"taskName":taskName,"surveyCode":"${surveyCode}","franchiseeId":"${franchiseeId}","btnCode":"${btnCode}","price":price,"franchiseeName":"${franchiseeName}"},null,null);--%>
    <%--}--%>
<%--</script>--%>
<%--</body>--%>
<%--</html>--%>
