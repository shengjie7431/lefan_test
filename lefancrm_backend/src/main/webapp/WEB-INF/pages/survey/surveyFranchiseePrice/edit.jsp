...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/baseSurvey/update" method="post">
        <input type="hidden" name="id" value="${surveyFranchiseePrice.id}">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id="franchiseeName" name="franchiseeName" value="${surveyFranchiseePrice.franchiseeName}" class="form-control" >
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="70%">
                        <select name="areaType" id ="areaType" class="form-control" required="required" onchange="toBuild()">
                            <option value="3" <c:if test="${surveyFranchiseePrice.areaType==3}">selected="selected" </c:if>>区</option>
                            <option value="2" <c:if test="${surveyFranchiseePrice.areaType==2}">selected="selected" </c:if>>市</option>
                            <option value="1" <c:if test="${surveyFranchiseePrice.areaType==1}">selected="selected" </c:if>>省</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="70%" class="form-inline">
                        <div class="form-group" id="provinceDiv" style="display: none">
                            ...
                            <c:forEach items="${apiRsp.results}" var="area">
                                <option value="${area.areaId}" <c:if test="${surveyFranchiseePrice.provinceId == area.areaId}"> selected="selected" </c:if>>${area.areaName}</option>
                            </c:forEach>
                        </select>
                        </div>
                        <div class="form-group" id="cityDiv" style="display: none">
                            ...
                            <c:forEach items="${cityApiRsp.results}" var="area">
                                <option value="${area.areaId}" <c:if test="${surveyFranchiseePrice.cityId == area.areaId}"> selected="selected" </c:if>>${area.areaName}</option>
                            </c:forEach>
                        </select>
                        ...
                        <div class="form-group" id="districtDiv" style="display: none">
                            ...
                            <c:forEach items="${districtApiRsp.results}" var="area">
                                <option value="${area.areaId}" <c:if test="${surveyFranchiseePrice.districtId == area.areaId}"> selected="selected" </c:if>>${area.areaName}</option>
                            </c:forEach>
                        </select>
                        </div>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id="taskName" name="taskName" value="${surveyFranchiseePrice.taskName}"  class="form-control" >
                        <%--<input type="hidden" id="taskId" name="taskId" value="${surveyFranchiseePrice.taskId}">--%>
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="number"  step="0.01" id = "taskPrice" name="taskPrice" value="${surveyFranchiseePrice.taskPrice}"  class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
