...
<head>
    ...
    <style>
        ...
        table thead tr:nth-of-type(2n) th:nth-of-type(4n){
            border-right-color:#aeaeae;
        }
    ...
    layui.use(['form', 'table', 'soulTable', 'xmSelect', 'laydate'], function () {
                        ...
                        return [{
                            ...
                            cols: [
                                [{
                                    ...
                                    children: function (row) {
                                        return [{
                                            ...
                                            url: '${ctx}/survey/hzReport/getDetail',
                                            where: {
                                                menuCode: "surveyManpower-son-item",
                                                searchType : "last30Days",
                                                orgId : row.surveyOrgId,
                                ...
                                [{
                                    ...
                                    sort: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.userNum1 * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    sort: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.userScore1 * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    totalRow: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.num6Rate * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    totalRow: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.score6Rate * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    sort: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.userNum5 * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    totalRow: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.num7Rate * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
                                    ...
                                    totalRow: true,
                                    templet: function (d) {
                                        var _d = Math.round(d.score7Rate * 10000) / 100
                                        var _html = '<div class="">' + _d + '%</div>'
                                        if (_d > 0) {
                                            _html = '<div class="color1">+' + _d + '%</div>'
                                        } else if (_d < 0) {
            ...
            var myTable = table.render({
                ...
                parseData: function(res){
                    resultsTotal = {
                        ...
                        "num6Rate": getRate(res.results.total.num6Rate) || '0%',
                        "num7Rate": getRate(res.results.total.num7Rate) || '0%',
                        ...
                        "score6Rate": getRate(res.results.total.score6Rate) || '0%',
                        "score7Rate": getRate(res.results.total.score7Rate) || '0%',
                    ...
                    return {
                        ...
                        "totalRow": {
                            ...
                            "userNum6": getFixed(res.results.total.userNum6) || '0',
                            "userNum7": getFixed(res.results.total.userNum7) || '0',
                            ...
                            "userScore6": getFixed(res.results.total.userScore6) || '0',
                            "userScore7": getFixed(res.results.total.userScore7) || '0',
                ...
                initSort: {
                    ...
                    if (resultsTotal.num6Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="num6Rate"] div').addClass('color2')
                    }else if (resultsTotal.num6Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="num6Rate"] div').addClass('color1')
                    }

                    if (resultsTotal.num7Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="num7Rate"] div').addClass('color2')
                    }else if (resultsTotal.num7Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="num7Rate"] div').addClass('color1')
                    }
                    ...
                    if (resultsTotal.score6Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="score6Rate"] div').addClass('color2')
                    }else if (resultsTotal.score6Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="score6Rate"] div').addClass('color1')
                    }

                    if (resultsTotal.score7Rate.indexOf('-') > -1){
                        $('.layui-table-total tbody tr td[data-field="score7Rate"] div').addClass('color2')
                    }else if (resultsTotal.score7Rate != '0%'){
                        $('.layui-table-total tbody tr td[data-field="score7Rate"] div').addClass('color1')
                    }
        ...
        function showTitle(thsJ, child,third ) {
            ...
            if (!child) {
                ...
                var _title1 = '当前做互助业务的机构内的全部调查员，包括合格调查员、有效调查员、调查新人、调查学员'
                ...
                var _title3 = '最近30天（不包括当天），平台复审通过状态的全部调查员的平均积分（包括阳性分）'
                ...
                var _title5 = '最近30天（不包括当天），平台复审通过的调查积分+阳性积分大于0分的调查员的数量'
                ...
                var _title7 = '最近30天（不包括当天），平台复审通过状态的全部活动调查员的平均积分（包括阳性分）'
                ...
                var _title8 = '最近30天（不包括当天），平台复审通过状态的调查积分+阳性积分大于等于250分的调查员的数量'
                ths.eq(8).find('.layui-table-cell').attr('title', _title8)

                var _title9 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(9).find('.layui-table-cell').attr('title', _title9)

                var _title10 = '最近30天（不包括当天），平台复审通过状态的全部合格调查员的平均积分（包括阳性分）'
                ths.eq(10).find('.layui-table-cell').attr('title', _title10)

                var _title11 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(11).find('.layui-table-cell').attr('title', _title11)

                var _title12 = '最近30天（不包括当天），平台复审通过状态的调查积分+阳性积分大于等于150分小于250分的调查员的数量'
                ths.eq(12).find('.layui-table-cell').attr('title', _title12)

                var _title13 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(13).find('.layui-table-cell').attr('title', _title13)

                var _title14 = '最近30天（不包括当天），平台复审通过状态的全部有效调查员的平均积分（包括阳性分）'
                ths.eq(14).find('.layui-table-cell').attr('title', _title14)

                var _title15 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(15).find('.layui-table-cell').attr('title', _title15)

                var _title16 = '最近30天（不包括当天），平台复审通过状态的调查积分+阳性积分大于等于50分小于150分的调查员的数量'
                ths.eq(16).find('.layui-table-cell').attr('title', _title16)

                var _title17 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(17).find('.layui-table-cell').attr('title', _title17)

                var _title18 = '最近30天（不包括当天），平台复审通过状态的全部调查新人的平均积分（包括阳性分）'
                ths.eq(18).find('.layui-table-cell').attr('title', _title18)

                var _title19 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(19).find('.layui-table-cell').attr('title', _title19)

                // var _title20 = '最近30天（不包括当天），平台复审通过状态的调查积分+阳性积分小于50分的调查员的数量'
                var _title20 = '最近30天（不包括当天），平台复审通过状态的阳性积分大于0分小于50分的调查员的数量'
                ths.eq(20).find('.layui-table-cell').attr('title', _title20)

                var _title21 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(21).find('.layui-table-cell').attr('title', _title21)

                var _title22 = '最近30天（不包括当天），平台复审通过状态的全部调查学员的平均积分（包括阳性分）'
                ths.eq(22).find('.layui-table-cell').attr('title', _title22)

                var _title23 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数×100%'
                ths.eq(23).find('.layui-table-cell').attr('title', _title23)

                var _title24 = '最近30天（不包括当天），平台复审通过的调查积分+阳性积分等于0分的调查员的数量'
                ths.eq(24).find('.layui-table-cell').attr('title', _title24)
                var _title25 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数*100%'
                ths.eq(25).find('.layui-table-cell').attr('title', _title25)
                var _title26 = '最近30天（不包括当天），平台复审通过状态的全部沉默调查员的平均积分（包括阳性分）'
                ths.eq(26).find('.layui-table-cell').attr('title', _title26)
                var _title27 = '连续2个统计周期（比如连续两月）内的量的变化比，环比=（本期数-上期数）/上期数*100%'
                ths.eq(27).find('.layui-table-cell').attr('title', _title27)
            }else {
                if (third){
                    ths.eq(3).find('.layui-table-cell span:first').after(icon_about)
                    ths.eq(4).find('.layui-table-cell span:first').after(icon_about)

                    var _title1 = '最近30天（不包括当天），平台复审通过状态的该调查员的总积分（调查分+阳性分）'
