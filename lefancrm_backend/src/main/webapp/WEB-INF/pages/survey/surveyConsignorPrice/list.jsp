...
<html>
<head>
    <title>调查委托方价格列表</title>
    <%@ include file="/WEB-INF/pages/common/mainCss.jsp" %>
</head>
<body>
<div class="main administrator">
    <div class="main-top">
        <h3>调查委托方价格列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/baseSurvey/list" method="post">
                   ...
                   <div class="form-group">
                       名称:<input name="enturyName" type="text" value="${enturyName}" class="form-control">
                   </div>
                    <div class="btn-group">
...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/baseSurvey/list?surveyCode=${surveyCode}&enturyName=${enturyName}" />
