...
<div class="main administrator">
    <div class="main-top">
        <h3>调查员级别列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/baseSurvey/list" method="post">
                   ...
                   <div class="form-group">
                       级别名称:<input name="name" type="text" value="${name}" class="form-control">
                   </div>
                    <div class="form-group">
                        级别code:<input name="code" type="text" value="${code}" class="form-control">
                    </div>
                    <div class="btn-group">
...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/baseSurvey/list?surveyCode=${surveyCode}&name=${name}&code=${code}" />
