        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="textarea" id = "question" name="question" value="${surveyQa.question}"  style="width: 400px;" class="form-control" readonly>
                    </td>
                </tr>
                <tr>
                    <th width="30%" class="active">答案</th>
                    <td width="70%">
                        <input type="textarea" id = "answer" name="answer" value="${surveyQa.answer}"  style="width: 400px;" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
