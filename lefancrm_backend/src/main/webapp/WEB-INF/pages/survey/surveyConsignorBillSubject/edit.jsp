...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/baseSurvey/update" method="post">
        <input type="hidden" name="id" value="${surveyConsignorBillSubject.id}">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    <th width="30%" class="active">开票对象名称</th>
                    <td width="70%">
                        <input type="text" id = "companyName" name="companyName" value="${surveyConsignorBillSubject.companyName}" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
