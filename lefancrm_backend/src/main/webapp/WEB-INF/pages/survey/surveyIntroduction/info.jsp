...
<body>
<div class="main">
    <input type="hidden" name="id" value="${surveyIntroduction.id}">
    <input type="hidden" name="surveyCode" value="${surveyCode}">
    <div class="title">
        <button class="butList active" onclick="operate('${surveyIntroduction.id}','${surveyCode}','1000',false);">修改</button>
        <%--<button class="butList defuelt" onclick="operate('${surveyIntroduction.id}','${surveyCode}','9999',true);">删除</button>--%>
    </div>
    <div class="main-boy">
        <div>
            <table class="spec-info" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>介绍标题</td>
                    <td>${surveyIntroduction.title}</td>
                    <td>摘要</td>
                    <td colspan="3">${surveyIntroduction.remark}</td>

                </tr>
                <tr>
                    <td>创建人</td>
                    <td>${surveyIntroduction.createByName}</td>
                    <td>创建时间</td>
                    <td><fmt:formatDate value="${surveyIntroduction.createTime}" pattern="yyyy-MM-dd HH:mm"/></td>
                    <td>更新时间</td>
                    <td><fmt:formatDate value="${surveyIntroduction.updateTime}" pattern="yyyy-MM-dd HH:mm"/></td>
                </tr>
                </tbody>
            </table>
        </div>
...
<div class="container">
    <div class="form-group">
        <table class="table">
            ...
            <tr>
                <td colspan="6">
                    <textarea class="form-control" name="content" id="content" style="width: 720px;height: 700px;" > ${surveyIntroduction.content}</textarea>
                </td>
            </tr>
            </tbody>
        </table>
