                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="buss" value="${item.id}"
                                    <c:forEach items="${priceModelConsignors}" var="my">
                            ...
                            <td class="companyName">
                                ${item.company}
                                    <c:forEach items="${priceModelConsignorAll}" var="all">
                                        <c:if test="${all.orgId == item.id }">
                                            <span style="color: #b3aaaa">(${all.priceModelName})</span>
                                        </c:if>
                                    </c:forEach>
                            </td>
                        </tr>
                ...
                <c:if test="${btnCode == 2100}">
                    <c:forEach items="${franchisees}" var="item">
                        <tr>
                            <td>
                                <input type="checkbox" name="buss" value="${item.id}"
                                    <c:forEach items="${priceModelFranchisees}" var="my">
                                        <c:if test="${my.orgId == item.id }">
                                            checked="checked"
                                        </c:if>
                                    </c:forEach>
