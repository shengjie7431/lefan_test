...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/baseSurvey/list?surveyCode=${surveyCode}&name=${name}&type=${type}&useObj=${useObj}" />
    ...
    function operate(id,surveyCode,btnCode,ajax,type,orgAttr){
        ...
        if(ajax){
            ...
            if(btnCode == '1000'){
                ...
                width = 1000;
                title = '设置委托方';
                url = "${ctx}/baseSurvey/popup?id="+id+"&surveyCode="+surveyCode+"&btnCode="+btnCode+"&type=1"+"&orgAttr="+orgAttr
            }else if(btnCode == '2100'){
                height = 650;
                width = 1000;
                title = '设置调查方';
                url = "${ctx}/baseSurvey/popup?id="+id+"&surveyCode="+surveyCode+"&btnCode="+btnCode+"&type=2"+"&orgAttr="+orgAttr
            ...
            if (btnCode == '9999' || btnCode == '10000'){
                if(confirm('是否确认？')){
                    $.post("${ctx}/baseSurvey/update",{"id":id,"surveyCode":surveyCode},function (e) {
                        // console.log(e)
                        window.reload();
                    })
                }
