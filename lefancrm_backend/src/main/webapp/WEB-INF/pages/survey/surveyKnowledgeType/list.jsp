...
<div class="main administrator">
    <div class="main-top">
        <h3>知识库类别列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
...
<div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/baseSurvey/list?surveyCode=${surveyCode}name=${name}&remark=${remark}" />
