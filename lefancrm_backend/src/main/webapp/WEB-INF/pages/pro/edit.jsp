...
<body>
<div class="container">
	<form id="editForm" role="form" action="${ctx}/proCategory/add" method="post">
	<div class="form-group">
		<table class="table">
	        <tbody>
	          <tr>
	            <th width="20%" class="active"><strong class="necessary">*</strong>分类标题</th>
	            <td width="80%"><input type="text" class="form-control" name="catName" placeholder="请输入分类标题" required="required"></td>
	          </tr>
	          <tr>
	            <th class="active"><strong class="necessary">*</strong>分类描述</th>
	            <td><input type="text" class="form-control" id="catDesc" name="catDesc" placeholder="请输入分类描述" ></td>
	          </tr>
	          <tr>
	            <th class="active"><strong class="necessary">*</strong>分类排序</th>
	            <td><input type="text" class="form-control" id="catSort" name="catSort" placeholder="请输入分类排序" ></td>
	          </tr>
              <tr>
