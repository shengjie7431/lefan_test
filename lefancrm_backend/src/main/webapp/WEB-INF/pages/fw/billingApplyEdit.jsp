...
<div class="container">
    <form id="editForm" role="form" action="${ctx}/billingApply/billingApplySave" method="post">
        ...
        <input type="hidden" id="billSource" name="billSource" value="fw">
        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <select name="businessType" id="businessType" class="form-control" style="width: 400px;" required="required">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <select name="billingEnum" id="billingEnum" class="form-control" style="width: 400px;" required="required" >
                            <option value="50">保险咨询服务</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="80%">
                        <select name="billingItem" id="billingItem" class="form-control" style="width: 400px;">
                            <option value="24">信息咨询服务费</option>
                            <option value="25">咨询服务费</option>
                            <option value="26">风险识别</option>
                            <option value="27">推广服务费</option>
                        </select>
                    </td>
                </tr>
                <tr>
...
<%--                    </td>--%>
        ...
        <div class="modal-footer">
            ...
            <button type="submit"  onclick="goBack()" class="btn btn-success loading-btn" data-loading-text="Loading..." autocomplete="off"><span class="glyphicon glyphicon-ok"></span> 确认开票</button>
        </div>
    </form>
</div>
