...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/caseCenterInfoAllot/updateOperator" method="post">
        <input type="hidden" name="caseId" value="${caseId}">
        <div class="form-group">
            <table class="table">
                <tbody>
                <tr>
                    <th width="30%" class="active">当前业务员:</th>
                    <td width="70%">
                        ${operatorName}
                    </td>
                </tr>
                <tr>
                    <th width="30%" class="active">指定业务员:</th>
                    <td width="70%">
