...
<div class="main administrator">
    <div class="main-top">
        <h3>公估开票到账月报表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="pin">
                <form class="form-inline" role="form" action="${ctx}/reportForm/caseAssessmentkpdzMonthReportList" method="post">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-default"><a href="${ctx}/reportForm/caseAssessmentkpdzMonthReportListExport?orgId=${orgId}&date=${date}&export=1">导出</a></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="main-bottom">
        <jsp:include page="/WEB-INF/pages/common/pagination.jsp" flush="true">
            ...
            <jsp:param name="requestUrl" value="${ctx}/reportForm/caseAssessmentkpdzMonthReportList?orgId=${orgId}&date=${date}" />
