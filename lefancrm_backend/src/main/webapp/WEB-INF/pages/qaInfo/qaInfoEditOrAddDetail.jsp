        ...
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <textarea class="form-control" name="question" id="question"  style="width: 400px;height: 130px;">${infoDetail.question}</textarea>
                    </td>
                </tr>
                <tr>
                    <th width="20%" class="active"><strong class="necessary"> </strong>答案</th>
                    <td width="80%"> <textarea class="form-control" name="answer" id="answer" style="width: 400px;height: 130px;" >${infoDetail.answer}</textarea></td>
                </tr>
                </tbody>
            </table>
        </div>
