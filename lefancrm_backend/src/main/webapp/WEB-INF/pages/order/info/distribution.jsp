...
<body>
<div class="container">
	<form id="editForm" role="form" action="${ctx}/orderInfo/distribution" method="post">
	<div class="form-group">
		<table class="table">
	        ...
	        <tbody>
	          <tr>
	            <th width="20%" class="active"><strong class="necessary">*</strong>物流单号</th>
	            <td width="80%"><input type="text" class="form-control" name="logisticCode" placeholder="请输入物流单号" required="required"></td>
	          </tr>
	          <tr>
