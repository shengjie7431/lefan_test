                ...
                <c:forEach items="${infos}" var="item">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:operate('${item.id}','priceAreaDel','9999',true);">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript">
    ...
    var add = function(id,surveyCode){
        openDialog({
            ...
            url:"${ctx}/finaManager/add?surveyCode="+surveyCode+"&priceModelId="+id
        });
    }
    ...
    function operate(id,surveyCode,btnCode,ajax){
        ...
        if(ajax){
            ...
            if(btnCode == '1000'){
                ...
                width = $(document.body).outerWidth() - 20;
                title = '修改';
                url = "${ctx}/finaManager/edit?id="+id+"&surveyCode="+surveyCode+"&priceModelId="+'${id}'
            }
            openDialog({
                frame:true,
                title:title,
    ...
    var addPrice = function(id,surveyCode,type){
        openDialog({
            ...
            height:800,
            width:$(document.body).outerWidth() - 20,
            url:"${ctx}/finaManager/edit?surveyCode="+surveyCode+"&priceModelId="+id+"&type="+type
        });
    }
</script>
</body>
