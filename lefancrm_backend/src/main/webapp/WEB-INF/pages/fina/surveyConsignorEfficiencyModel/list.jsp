...
<div class="main administrator">
    <div class="main-top">
        <h3>时效模板列表 <small>共<span>${apiRsp.count}</span>个</small></h3>
    </div><!--main-top-->
            ...
            <c:forEach items="${apiRsp.results}" var="item">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:operate('${item.id}','${surveyCode}',2000,false,'${type}');">设置委托方</a>
...
<script>
    ...
    var add = function(surveyCode,type){
        openDialog({
            ...
            width : 1500,
            height : 750,
            url:"${ctx}/finaManager/add?surveyCode="+surveyCode+"&type="+type
        });
    }
    ...
    function operate(id,surveyCode,btnCode,ajax,type){
        ...
        if(ajax){
            var url = "${ctx}/finaManager/operate",param = {"id":id,"surveyCode":"agingModelDel","btnCode":btnCode,"type":type};
            if(confirm('是否确认？')){
            ...
            if(btnCode == '1000'){
                ...
                height = 750;
                title = '修改';
                url = "${ctx}/finaManager/edit?id="+id+"&surveyCode="+surveyCode+"&btnCode="+btnCode+"&type="+type
