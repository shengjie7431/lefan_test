...
<body>
<input type="hidden" value="${pathId}" id="pathId">
...
<div class="layui-form layui-form-content">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label label-input" style="width: 130px">本次还款来源</label>
            <div class="layui-input-inline" style="width: 340px;">
                <div class="lf-bars">
                    <div class="lf-bar " data-id="1" style="border-right: none;">保司还款</div>
                    <div class="lf-bar active" data-id="2">客户还款</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block" style="margin-left:0;margin-top: 30px;text-align: center">
            ...
            <button class="layui-btn layui-btn-normal submit-btn" data-type="1" style="width: 100px;">足额还款</button>
            <button class="layui-btn layui-btn-normal submit-btn" data-type="2" style="width: 150px;display: none">仅提交本次还款</button>
            <button class="layui-btn layui-btn-normal submit-btn" data-type="3" style="width: 200px;display: none">不足额还款，转风险案件</button>
    ...
    layui.use(['jquery', 'layer', 'util','laydate', 'upload'], function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('.repay-no').val(res.results.notRepayMoney)
        ...
        $('.repay-cur').keyup(function () {
            ...
            if (repayCurMoney > repayNoMoney || repayCurMoney == repayNoMoney || !$(this).val()){
                $('.submit-btn[data-type=1]').show()
                $('.submit-btn[data-type=2]').hide()
                $('.submit-btn[data-type=3]').hide()
            }else if (repayCurMoney < repayNoMoney){
                $('.submit-btn[data-type=1]').hide()
                $('.submit-btn[data-type=2]').show()
                $('.submit-btn[data-type=3]').show()
            }
        ...
        $('.submit-btn').click(function () {
            ...
            if (type == 1){
                ...
                codeType = 'not-all-commit-to-risk'
            }
            var files= []
            ...
            $.ajax({
                ...
                data: {
                    ...
                    repaymentMoney: $('.repay-cur').val(),
                    repaymentSource: $('.lf-bar.active').attr('data-id'),
