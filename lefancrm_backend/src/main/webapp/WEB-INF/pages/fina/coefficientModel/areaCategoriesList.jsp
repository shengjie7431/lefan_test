    ...
    <div class="panel panel-info">
        <form id="editForm" role="form" action="${ctx}/finaManager/operate" method="post">
            ...
            <table class="table table-hover">
                <thead>
<%--                coefficientModelArea--%>
                <button onclick="add('${id}','coefModelAreaCategories')" type="button" class="btn btn-default">添加区域类别</button>
                <button onclick="addPrice('${id}','coefEfficiency','${type}')" type="button" class="btn btn-default">设置系数</button>
<%--                <button data-id="${id}" type="button" class="btn btn-default copyPrice">快速从价格复制区域类别</button>--%>
                ...
                <c:forEach items="${infos}" var="item">
                    <tr>
                        ...
                        <td>
                            <a href="javascript:operate('${item.id}','coefModelAreaCategories','1000',false);">修改</a>
                            <a href="javascript:operate('${item.id}','coefAreaDel','9999',true);">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
