...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/invocie/doInvoiceUpload" method="post">
        ...
        <div class="form-group">
            <table class="table">
                <tbody>
                <tr>
                    <th class="active"><strong class="necessary">*</strong>发票票据</th>
                    <td>
                        <input required id="adPic" type="hidden" value="${infoDetail.img}" name="invoiceFile">
                        <img id="infImg" src="${infoDetail.img}" width="80" height="80">
                        <input id="fileupload" type="file"  name="file" multiple  data-url="${ctx}/uploadImage?moduleName=shareCase/${caseCode}">
                    </td>
                </tr>
                </tbody>
            </table>
