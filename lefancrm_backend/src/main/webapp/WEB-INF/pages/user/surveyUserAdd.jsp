   ...
   <form id="editForm" role="form" class="form-horizontal" action="${ctx}/baseSurvey/update" method="post">
       ...
       <input type="hidden" name="surveyCode" value="${surveyCode}">
        <div class="form-group">
            <table class="table" >
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input type="text" id = "userTel" name="userTel"  value="${userInfo.userTel}" class="form-control">
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="modal-footer">
            <button type="button"  onclick="return valid()" class="btn btn-success loading-btn" data-loading-text="Loading..." autocomplete="off"><span class="glyphicon glyphicon-ok"></span> 确认提交</button>
        </div>
    </form>
</div>
...
<script type="text/javascript">
    ...
    function valid(){
        ...
        $.ajax({
            url:"${ctx}/baseSurvey/operate?userTel="+userTel+"&surveyCode=authenticationPhone",
            type:'POST',
            dataType:'json',
