...
<body>
<div class="container">
    <form id="editForm" role="form" action="${ctx}/caseApplication/editLoanApplicationInfoState" method="post">
        <div class="form-group">
            <table class="table">
                ...
                <tr>
                    ...
                    <td width="80%">
                        <textarea id = "reson" name="reson" style="width: 430px;height: 200px" class="form-control"></textarea>
                    </td>
                </tr>
                </tbody>
            </table>
