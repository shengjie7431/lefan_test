        ...
        init: function () {
            return this.each(function (i) {
                ...
                if (!($.browser.msie && $.browser.version < 9)) {
                    ...
                    UCSelectBoxBottom < UCSelectBoxHeight && UCSelectBoxTop > UCSelectBoxBottom ? UCSelectBox.css({
                        top: -UCSelectBoxHeight + (UCSelectVal.offset().top - UCSelect.offset().top)
                    }) : UCSelectBox.css({
                        top: UCSelectVal.outerHeight() + (UCSelectVal.offset().top - UCSelect.offset().top)
                    });
