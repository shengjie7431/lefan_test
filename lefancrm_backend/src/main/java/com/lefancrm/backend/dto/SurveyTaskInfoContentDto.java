...
public class SurveyTaskInfoContentDto {
    private Long id;
    ...
    private List<SurveyTaskDirectionResultDto> taskDirectionResults;
    ...
    public List<SurveyTaskDirectionResultDto> getTaskDirectionResults() {
        return taskDirectionResults;
    }

    public void setTaskDirectionResults(List<SurveyTaskDirectionResultDto> taskDirectionResults) {
