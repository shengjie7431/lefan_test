 ...
 * @author EDZ
 */
public class SurveyInvestigatorDto {
    private Long id;
    ...
    private List<BusinessRoleDto>  businessRole;

    private Integer dcyCaseNum; //调查中案件数量

    private String signUrl; //个人签名url
    ...
    public List<BusinessRoleDto> getBusinessRole() {
        return businessRole;
    }

    public void setBusinessRole(List<BusinessRoleDto> businessRole) {
