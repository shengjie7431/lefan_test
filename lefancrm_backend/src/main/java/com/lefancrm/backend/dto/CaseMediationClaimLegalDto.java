...
public class CaseMediationClaimLegalDto {
    private Long id;
    ...
    private List<CaseMediationClaimReportDto> caseMediationClaimReports;
    ...
    public List<CaseMediationClaimReportDto> getCaseMediationClaimReports() {
        return caseMediationClaimReports;
    }

    public void setCaseMediationClaimReports(List<CaseMediationClaimReportDto> caseMediationClaimReports) {
