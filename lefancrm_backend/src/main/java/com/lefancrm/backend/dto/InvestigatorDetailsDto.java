...
public class InvestigatorDetailsDto {
     ...
     * 分配任务类型
     */
    private List<SurveyInvestigatorCaseTypeDto> taskTypeList;
    ...
    public List<SurveyInvestigatorCaseTypeDto> getTaskTypeList() {
        return taskTypeList;
    }

    public void setTaskTypeList(List<SurveyInvestigatorCaseTypeDto> taskTypeList) {
