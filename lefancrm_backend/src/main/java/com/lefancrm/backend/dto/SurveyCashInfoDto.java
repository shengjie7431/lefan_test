...
public class SurveyCashInfoDto {
    ...
    private SurveyFranchiseeDto surveyFranchisee; //加盟机构
    private SurveyBankCardDto surveyBankCard; //银行卡号
    private List<SurveyCashInfoDetailDto> surveyCashInfoDetails;//提现明细
    private SurveyCashInfoDto surveyCashInfo; //提现记录
    private List<SurveyCashInfoRecordDto> surveyCashInfoRecords;//提现数据表
    ...
    public SurveyBankCardDto getSurveyBankCard() {
        return surveyBankCard;
    }

    public void setSurveyBankCard(SurveyBankCardDto surveyBankCard) {
        this.surveyBankCard = surveyBankCard;
    }

    public List<SurveyCashInfoDetailDto> getSurveyCashInfoDetails() {
        return surveyCashInfoDetails;
    }

    public void setSurveyCashInfoDetails(List<SurveyCashInfoDetailDto> surveyCashInfoDetails) {
        this.surveyCashInfoDetails = surveyCashInfoDetails;
    }

    public SurveyCashInfoDto getSurveyCashInfo() {
        return surveyCashInfo;
    }

    public void setSurveyCashInfo(SurveyCashInfoDto surveyCashInfo) {
        this.surveyCashInfo = surveyCashInfo;
    }

    public List<SurveyCashInfoRecordDto> getSurveyCashInfoRecords() {
        return surveyCashInfoRecords;
    }

    public void setSurveyCashInfoRecords(List<SurveyCashInfoRecordDto> surveyCashInfoRecords) {
