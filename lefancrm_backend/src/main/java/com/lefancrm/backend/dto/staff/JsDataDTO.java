...
public class JsDataDTO {
    ...
    private String conpanyFundMoney; //公积金

    private String personalFundMoney;

    private String companyPensionBenefits;//养老保险

    private String personalPensionBenefits;

    private String companyMedicalInsurance;//医疗保险

    private String personalMedicalInsurance;

    private String companyUnemploymentInsurance;//失业保险

    private String personalUnemploymentInsurance;

    private String companyBirthInsurance;//生育险
    ...
    private String companySickSubsidy; //大病补助

    private String personalSickSubsidy;
