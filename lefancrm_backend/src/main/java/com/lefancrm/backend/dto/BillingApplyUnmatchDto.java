...
public class BillingApplyUnmatchDto {
    private Long id;
    ...
    private List<BillingReceiveInfoDto> receiveInfos;//认领明细
    ...
    public List<BillingReceiveInfoDto> getReceiveInfos() {
        return receiveInfos;
    }

    public void setReceiveInfos(List<BillingReceiveInfoDto> receiveInfos) {
