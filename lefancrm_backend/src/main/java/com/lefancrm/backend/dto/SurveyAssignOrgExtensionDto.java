...
public class SurveyAssignOrgExtensionDto {
    private Long id;
    ...
    private SurveyEmailInfoDTO surveyEmailInfo;//发送邮件的信息
    ...
    public SurveyEmailInfoDTO getSurveyEmailInfo() {
        return surveyEmailInfo;
    }

    public void setSurveyEmailInfo(SurveyEmailInfoDTO surveyEmailInfo) {
