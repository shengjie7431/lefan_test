...
public class SurveyConsignorDto {
    private Long id;
    ...
    private List<SurveyConsignorDepartmentDto> surveyConsignorDepartment;
    ...
    private List<BillingApplyCompanyDto> companys;//开票对象
    ...
    public List<SurveyConsignorDepartmentDto> getSurveyConsignorDepartment() {
        return surveyConsignorDepartment;
    }

    public void setSurveyConsignorDepartment(List<SurveyConsignorDepartmentDto> surveyConsignorDepartment) {
    ...
    public List<BillingApplyCompanyDto> getCompanys() {
        return companys;
    }

    public void setCompanys(List<BillingApplyCompanyDto> companys) {
