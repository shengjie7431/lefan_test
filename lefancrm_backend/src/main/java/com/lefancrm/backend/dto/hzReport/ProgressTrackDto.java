...
import com.lefancrm.backend.dto.SurveyAssignOrgTypeDto;
import com.lefancrm.backend.dto.SurveyInvestigatorCaseTypeDto;
...
public class ProgressTrackDto {
    ...
    private List<SurveyRiskCaseInfoDto> surveyRiskCaseInfoList;//案件信息
    //案件信息
    ...
    private List<SurveyInvestigatorCaseTypeDto> investigatorCaseTypes;
    ...
    private String orgReturnState; //是否复审驳回
    private Integer orgIsSun;//是否标记阳性: 0、否，1、是
    private String orgTaskRemark;//调查需求
    private Long reviewUserId;
    private Date reviewTime;
    private List<SurveyAssignOrgTypeDto> surveyAssignOrgTypes;
    ...
    public List<SurveyRiskCaseInfoDto> getSurveyRiskCaseInfoList() {
        return surveyRiskCaseInfoList;
    }

    public void setSurveyRiskCaseInfoList(List<SurveyRiskCaseInfoDto> surveyRiskCaseInfoList) {
        this.surveyRiskCaseInfoList = surveyRiskCaseInfoList;
    }

    public List<SurveyInvestigatorCaseTypeDto> getInvestigatorCaseTypes() {
        return investigatorCaseTypes;
    }

    public void setInvestigatorCaseTypes(List<SurveyInvestigatorCaseTypeDto> investigatorCaseTypes) {
        this.investigatorCaseTypes = investigatorCaseTypes;
    }

    public List<SurveyAssignOrgTypeDto> getSurveyAssignOrgTypes() {
        return surveyAssignOrgTypes;
    }

    public void setSurveyAssignOrgTypes(List<SurveyAssignOrgTypeDto> surveyAssignOrgTypes) {
    ...
    public String getOrgReturnState() {
        return orgReturnState;
    }

    public void setOrgReturnState(String orgReturnState) {
