...
/**
 * Created by wangwei on 2018/11/5.
 */
public class CustomerNumberDto {
    private Integer number1; //待审核案件
    private Integer number2; //待分配案件
    private Integer number3; //待提现审核

    private Integer type1; //待支付案件
    private Integer type2; //超时未接收
    private Integer type3; //超时未跟踪
    private Integer type4; //超时状态未变更
    private Integer type5; //超时未签约
    private Integer type6; //扣罚记录
    private Integer type7; //伤残赔付待转办
    private Integer type8; //解约审核
    ...
    public Integer getTitle6() {
        return title6;
    }

    public void setTitle6(Integer title6) {
        this.title6 = title6;
    }

    public Integer getTitle10() {
        return title10;
    }

    public void setTitle10(Integer title10) {
        this.title10 = title10;
    }

    public Integer getTitle11() {
        return title11;
    }

    public void setTitle11(Integer title11) {
        this.title11 = title11;
    }

    public Integer getTitle12() {
        return title12;
    }

    public void setTitle12(Integer title12) {
