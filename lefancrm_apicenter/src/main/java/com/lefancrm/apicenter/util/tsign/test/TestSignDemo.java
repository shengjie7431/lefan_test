package com.lefancrm.apicenter.util.tsign.test;
...
public class TestSignDemo {
	...
	public static void main(String[] args) {
		...
		case 0:
			...
			// 使用标准的模板印章签署
			doSignWithTemplateSealByStream(srcPdfFile, signedFolder, signedFileName,companyName,organCode, companyAddress,agentName, agentIdNo);
			break;
		case 1:
			System.out.println("----<场景演示：使用上传的印章图片签署，签署人之间用文件二进制流传递>----");
			// 使用上传的印章图片签署
			doSignWithImageSealByStream(srcPdfFile, signedFolder, signedFileName,companyName,organCode, companyAddress,agentName, agentIdNo);
			break;
		case 2:
	 ...
	 */
	public static void doSignWithTemplateSealByStream(String srcPdfFile, String signedFolder, String signedFileName,String companyName,String organCode, String companyAddress, String agentName, String agentIdNo) {
		// 创建个人客户账户
	 ...
	 * @param signedFileName
	 */
	public static void doSignWithImageSealByStream(String srcPdfFile, String signedFolder, String signedFileName,String companyName,String organCode, String companyAddress, String agentName, String agentIdNo) {
		// 个人印章图片文件路径
		String personImgFilePath = "images" + File.separator + "bb4d94fb91eb43a2b8a65ea0f8105272.jpg";
		// 企业印章图片文件路径
...
//		String organizeSealData = SignHelper.getSealDataByImage(organizeImgFilePath);
		String organizeSealData = userOrganizeSealData.getSealData();
