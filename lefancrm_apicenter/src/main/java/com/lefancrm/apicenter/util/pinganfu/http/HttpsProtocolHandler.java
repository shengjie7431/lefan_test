...
public class HttpsProtocolHandler {
    ...
    private static HttpsProtocolHandler httpProtocolHandler                 = new HttpsProtocolHandler();
...
//        RequestEntity entity = new ByteArrayRequestEntity(request.getRequestBody().getBytes(),
