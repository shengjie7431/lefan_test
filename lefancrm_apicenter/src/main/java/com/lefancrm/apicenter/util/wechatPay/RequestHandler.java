package com.lefancrm.apicenter.util.wechatPay;
...
import com.lefancrm.apicenter.util.wechatPay.util.TenpayUtil;
import com.lefancrm.apicenter.util.wechatPay.util.TenpayUtils;
...
public class RequestHandler {
     ...
     * 初始化函数。
     */
    public void init(String app_id, String partner, String key) {
        this.last_errcode = "0";
        this.debugInfo = "";
        this.appid = app_id;
    ...
    // 提交预支付
    public String sendPrepay(SortedMap packageParams) throws JDOMException, IOException {
        ...
        // 生成签名
        String packageSign = TenpayUtils.createSign(packageParams);
    ...
    // 提交预支付
    public String sendJsPrepay(SortedMap packageParams) throws JDOMException, IOException {
        ...
        // 生成签名
        String packageSign = TenpayUtils.createJsSign(packageParams);
        sb2.append("<sign><![CDATA[");
        sb2.append(packageSign);
        sb2.append("]]></sign>");
        sb2.append("</xml>");
    ...
    // 提交关单相关操作
    public String sendCloseOrder(SortedMap packageParams) throws JDOMException, IOException {
        ...
        // 设置链接参数
        String postData = sb2.toString();
        String requestUrl = getCloseorderUrl();
        System.out.println("post url=" + requestUrl);
        System.out.println("post data=" + postData);
        TenpayHttpClient httpClient = new TenpayHttpClient();
        httpClient.setReqContent(requestUrl);
    ...
    // 支付推广费用
    public String sendPayToCar(SortedMap packageParams,String path) throws  Exception {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("<xml>");
        Set es = packageParams.entrySet();
        Iterator it = es.iterator();
        ...
        // 生成签名
        String sign = TenpayUtils.createJsSign(packageParams);
        sb2.append("<sign><![CDATA[");
        sb2.append(sign);
        sb2.append("]]></sign>");
        sb2.append("</xml>");
        ...
        System.out.println("payToCar***************** post data=" + postData);
        TenpayHttpClient httpClient = new TenpayHttpClient();
        String resContent = httpClient.postTFMSSL(requestUrl, postData, path);
        System.out.println("********************************payToCar***************** resContent=" + resContent);
        return resContent;
    }
    /**
     * 创建package签名
    ...
    // 提交关单相关操作
    public String refundOf(SortedMap packageParams,String path) throws  Exception {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("<xml>");
        Set es = packageParams.entrySet();
        Iterator it = es.iterator();
        ...
        // 生成签名
        String sign = TenpayUtils.createSign(packageParams);
        sb2.append("<sign><![CDATA[");
        sb2.append(sign);
        sb2.append("]]></sign>");
        sb2.append("</xml>");
        ...
        System.out.println("***************** post data=" + postData);
        TenpayHttpClient httpClient = new TenpayHttpClient();
        String resContent = httpClient.postOfMSSL(requestUrl, postData, path);
