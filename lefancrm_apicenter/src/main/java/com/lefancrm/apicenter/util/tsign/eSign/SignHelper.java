package com.lefancrm.apicenter.util.tsign.eSign;
...
public class SignHelper {
	...
	public static FileDigestSignResult userPersonSignByStream(byte[] pdfFileStream, String accountId,
		...
		// 设置坐标定位签署的PosBean，坐标定位方式支持单页签章、多页签章和骑缝章，但对关键字签章指定页码无效；
		PosBean posBean = setKeyPosBean("6018");
//		PosBean posBean = setKeyPosBean("赵某某");
		// 设置签署类型为 关键字签章
...
//		personBean.setMobile("152****4800");
		// 姓名
		personBean.setName("姜松");
		// 身份证号/护照号
		personBean.setIdNo("42032219901201333X");
	 ...
	 */
	public static String addOrganizeAccount(String companyName,String organCode, String companyAddress, String agentName, String agentIdNo) {
...
//		organizeBean.setMobile("188****0787");
		// 企业名称
		organizeBean.setName(companyName);
		//organizeBean.setName("上海乐凡金融信息服务有限公司");
		...
		// 公司地址,可空
		organizeBean.setAddress(companyAddress);
		// 经营范围,可空
