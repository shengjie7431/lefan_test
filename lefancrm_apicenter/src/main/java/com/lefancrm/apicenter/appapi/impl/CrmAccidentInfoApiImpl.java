...
public class CrmAccidentInfoApiImpl extends BaseServiceImpl implements CrmAccidentInfoApi {
    ...
    @ApiMethod(needLogin = true, descript = "查询事故信息", value = "query-accident-details")
    @Override
     ...
     */
    @SuppressWarnings("rawtypes")
    @ApiMethod(needLogin = true, descript = "编辑事故信息", value = "edit-accident-info")
    @Override
