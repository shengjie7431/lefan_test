...
public class CrmCustomerFollowsApiImpl extends BaseServiceImpl implements CrmCustomerFollowsApi {

    private static final Logger loger = Logger.getLogger(CrmCustomerFollowsApiImpl.class);
    @Autowired
...
/**
    ...
    @ApiMethod(needLogin = true, descript = "查询跟进状态", value = "query-customer-follows")
    @Override
     ...
     */
    @SuppressWarnings("rawtypes")
    @ApiMethod(needLogin = true, descript = "添加跟进状态", value = "add-customer-follows")
    @Override
