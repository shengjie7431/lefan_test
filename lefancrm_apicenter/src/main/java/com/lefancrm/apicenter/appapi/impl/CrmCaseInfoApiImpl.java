...
import com.lefancrm.apicenter.appapi.CrmCaseInfoApi;
...
public class CrmCaseInfoApiImpl extends BaseServiceImpl implements CrmCaseInfoApi {
    ...
    @ApiMethod(needLogin = true, descript = "查询案件信息", value = "query-case-info-details")
    @Override
     ...
     */
    @SuppressWarnings("rawtypes")
    @ApiMethod(needLogin = true, descript = "编辑案件信息", value = "edit-case-info")
    @Override
