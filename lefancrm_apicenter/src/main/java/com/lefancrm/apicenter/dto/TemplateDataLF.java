...
public class TemplateDataLF {
    ...
    private String surveyUserAddress;
    ...
    public String getSurveyUserAddress() {
        return surveyUserAddress;
    }

    public void setSurveyUserAddress(String surveyUserAddress) {
        this.surveyUserAddress = surveyUserAddress;
    }
