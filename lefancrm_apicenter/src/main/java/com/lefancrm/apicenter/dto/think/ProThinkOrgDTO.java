...
public class ProThinkOrgDTO {
    ...
    public ProThinkOrgDTO() {
    }

    public ProThinkOrgDTO(Long orgId, String orgName) {
        this.orgId = orgId;
        this.orgName = orgName;
    }

    public ProThinkOrgDTO(Long orgId, String orgName, Long proId) {
        this.orgId = orgId;
        this.orgName = orgName;
        this.proId = proId;
    }

    public ProThinkOrgDTO(Long orgId, String orgName, Long proId, String proName) {
        this.orgId = orgId;
        this.orgName = orgName;
        this.proId = proId;
