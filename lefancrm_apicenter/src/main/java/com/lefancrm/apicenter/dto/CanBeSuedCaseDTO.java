...
public class CanBeSuedCaseDTO {
    ...
    private String entrustOprDateStr;
    ...
    public String getEntrustOprDateStr() {
        return entrustOprDateStr;
    }

    public void setEntrustOprDateStr(String entrustOprDateStr) {
        this.entrustOprDateStr = entrustOprDateStr;
    }
