...
public class UserAccountDto {
    ...
    private Double isWithdrawDeposit;//已经提现金额

    public Double getIsWithdrawDeposit() {
        return isWithdrawDeposit;
    }

    public void setIsWithdrawDeposit(Double isWithdrawDeposit) {
        this.isWithdrawDeposit = isWithdrawDeposit;
    }
