...
public class BackendCrmInjuryInfoApiImpl extends BaseServiceImpl implements CrmInjuryInfoApi{

    @Autowired
    private CrmInjuryInfoMapper crmInjuryInfoMapper;

    @SuppressWarnings("rawtypes")
    @ApiMethod( descript = "查询伤情信息", value = "query-injury-info")
    @Override
    ...
    @SuppressWarnings("rawtypes")
    @ApiMethod( descript = "编辑伤情信息", value = "backend-edit-injury-info")
    @Override
