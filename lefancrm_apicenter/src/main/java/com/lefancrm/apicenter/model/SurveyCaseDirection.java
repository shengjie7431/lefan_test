...
public class SurveyCaseDirection {
    private Long id;
    ...
    private Long directionResultTypeId;//任务结果
    ...
    private Integer haveReimbursement;
    ...
    private Integer channelType;//是否为渠道费用(0否 1是)
    ...
    public Integer getHaveReimbursement() {
        return haveReimbursement;
    }

    public void setHaveReimbursement(Integer haveReimbursement) {
