...
public class SurveyConsignorEfficiencyModelArea {
    ...
    List<SurveyConsignorEfficiencyModelInfo> modelInfos;
    ...
    public List<SurveyConsignorEfficiencyModelInfo> getModelInfos() {
        return modelInfos;
    }

    public void setModelInfos(List<SurveyConsignorEfficiencyModelInfo> modelInfos) {
