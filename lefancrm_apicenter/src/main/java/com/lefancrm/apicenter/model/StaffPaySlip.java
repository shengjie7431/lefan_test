...
//    private List<StaffPayInfoDTO> slips;
    ...
    private List<StaffPayPersonnelSlip> slips;

    private StaffPayPersonnelSlip staffPayPersonnelSlip;// 修改单个员工数据的时候存在该对象
    ...
    public List<StaffPayPersonnelSlip> getSlips() {
        return slips;
    }

    public void setSlips(List<StaffPayPersonnelSlip> slips) {
        this.slips = slips;
    }
    ...
    public StaffPayPersonnelSlip getStaffPayPersonnelSlip() {
        return staffPayPersonnelSlip;
    }

    public void setStaffPayPersonnelSlip(StaffPayPersonnelSlip staffPayPersonnelSlip) {
    ...
    public StaffPaySlipManager getStaffPaySlipManager() {
        return staffPaySlipManager;
    }

    public void setStaffPaySlipManager(StaffPaySlipManager staffPaySlipManager) {
