...
public class FinancialCostBear {
    ...
    private String organManagerUserName;
    ...
    public String getOrganManagerUserName() {
        return organManagerUserName;
    }

    public void setOrganManagerUserName(String organManagerUserName) {
        this.organManagerUserName = organManagerUserName;
    }

    public String getSuperiorManagerUserName() {
        return superiorManagerUserName;
    }

    public void setSuperiorManagerUserName(String superiorManagerUserName) {
        this.superiorManagerUserName = superiorManagerUserName;
    }
