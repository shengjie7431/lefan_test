...
public class SurveyInvestigatorReInfo {
    private Long id;
    ...
    private Double crossTrafficMoney;
    ...
    private Double huanbiMoney;//均件环比上月
    ...
    public Double getCrossTrafficMoney() {
        return crossTrafficMoney;
    }

    public void setCrossTrafficMoney(Double crossTrafficMoney) {
        this.crossTrafficMoney = crossTrafficMoney;
    }
    ...
    public Double getAvgMoney2() {
        return avgMoney2;
    }

    public void setAvgMoney2(Double avgMoney2) {
        this.avgMoney2 = avgMoney2;
    }
}