...
<div align="center" ><img src="<%=defaultApiServer %>/image/u2.png"></div>
    <div>
        <p align="left">
            ...
            竞赛等概念和UI 设计，来增强用户粘性。目标通过不断更新功能，带入游戏设计性的内容，打造平台型的运动类app软件
        </p>
    </div>
    </br>
    </br>
    <div align="center" ><a href="<%=defaultApiServer %>/api/page/platformRule"  style="text-decoration:none;">用户隐私协议》</a></div>
